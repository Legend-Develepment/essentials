...
return [
    ...
    'icons' => [
        ...
        'pack_partial_body' => 'Skipped: :big too large for one icon, :unusable not usable as SVG, :duplicate sharing a name with one already taken. An SVG over 256 KB is nearly always a picture wrapped in one rather than a drawing — export it at icon size and it will be a few kilobytes.',
