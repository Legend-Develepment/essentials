...
return [
    'updating_now' => '這個面板正在安裝更新。有的頁面可能會怪一下。',
    'updating_done' => '更新裝好了。要是剛才有頁面看起來怪怪的，重新整理一下。',
    'title' => 'Essentials 設定',
    ...
    'cron_missing' => '面板的排程器已經 :for 分鐘沒跑了。續約、watchdog 檢查和自動更新全都等著它。cron 那一行寫在 Pelican 的文件裡。',
