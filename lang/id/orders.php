...
return [
    ...
    'cancel' => 'Batalkan',
    'cancel_confirm' => 'Layanan berjalan sampai :date dan tidak ditagih lagi. Pada hari itu servernya dihapus beserta semua isinya. Pelanggan diberi tahu keduanya sekarang.',
    ...
    'not_paid' => 'Pesanan ini tidak punya faktur yang terbayar, jadi tidak ada yang dibuat. Kalau memang sudah dibayar, faktur yang dipakai membayar tidak mencantumkan pesanan ini - beri tahu yang mengelola panel ini.',
    ...
    'by_customer' => 'Diakhiri oleh pelanggan',
    'by_admin' => 'Diakhiri di sini',
    'filter_by' => 'Siapa yang mengakhiri',
    'details' => 'Rincian',
    'details_of' => 'Pesanan :number',
    'close' => 'Tutup',
    'detail_package' => 'Paket',
    'detail_placed' => 'Dipesan',
    'detail_built' => 'Server dibuat',
    'detail_due' => 'Jatuh tempo berikutnya',
    'detail_ends' => 'Berakhir',
    'detail_suspended' => 'Dihentikan',
    'detail_cancelled' => 'Dibatalkan',
    'detail_file_in' => 'Berkas dimasukkan',
    'detail_file_waiting' => 'Berkas',
    'detail_file_waiting_value' => 'Sudah diunggah, menunggu server dibuat.',
    'detail_note' => 'Masalah terakhir',
