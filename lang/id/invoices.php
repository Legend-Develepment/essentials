...
return [
    ...
    'kind_credit' => 'Nota kredit',
    'kind_upgrade' => 'Ganti paket',
    'kind_topup' => 'Tambah saldo',
    'kind_addon' => 'Tambahan',
    ...
    'order_count' => ':count layanan',
    'no_due' => 'Tanpa tanggal',
    'gone_customer' => 'Akun dihapus',
    'discount_of' => 'Potongan :amount dengan :code',
    'paid_via' => 'lewat :how',
    'column_attempts' => 'Pembayaran',
    'paid_by' => 'dibayar dengan :how',
    'paid_by_unknown' => 'dibayar',
    'paid_by_manual' => 'tangan',
    'paid_by_free' => 'tidak ada yang harus dibayar',
    'attempts_none' => 'tanpa upaya',
    'attempts_open' => ':count upaya - :how',
    'attempt_last' => 'terakhir :when, :state',
    'attempt_open' => 'belum selesai',
    'attempt_paid' => 'dibayar',
    'attempt_cancelled' => 'dibatalkan',
    'attempt_failed' => 'gagal',
    'emailed' => 'Terkirim',
    ...
    'doc_from' => 'Dari',
    'doc_vat' => 'Nomor PPN',
    'doc_coc' => 'Nomor registrasi usaha',
