...
return [
    ...
    'delete_confirm_sold' => 'Paket ini sudah terjual :count kali. Layanan itu tidak disentuh: setiap pesanan menyimpan salinannya sendiri tentang semua yang dijual bersamanya, jadi servernya tetap berjalan dan fakturnya tetap menyebut apa yang dibeli. Yang hilang hanya gambar di kartu layanan mereka, dan paketnya berhenti dijual.',
    ...
    'deleted_sold' => ':count layanan yang terjual darinya tidak disentuh dan tetap berjalan.',
    ...
    'upgrade_to' => 'Bisa diganti ke',
    'upgrade_to_helper' => 'Ke paket mana layanan yang berjalan di paket ini boleh dipindahkan, naik atau turun. Hanya paket dengan egg yang sama yang didaftar, karena egg yang lain berarti server yang lain, bukan server yang lebih besar. Tidak ada yang dicentang berarti paket ini tidak bisa ditinggalkan.',
    'upgrade_to_none' => 'Belum ada paket lain yang memakai egg ini.',
    ...
    'popular' => 'Tunjuk yang ini',
    'popular_helper' => 'Menandainya sebagai yang paling banyak dipilih orang. Paket itu naik di toko, di bawah apa pun yang sedang diskon, dan membawa tanda kecil. Bukan klaim tentang angka penjualan - ini penjaga toko yang menunjuk.',
    'offer' => 'Sedang diskon',
    'offer_helper' => 'Memindahkannya ke depan toko dengan tanda padanya, dan memotong harganya dengan diskon di bawah.',
    'offer_kind' => 'Diskon sebagai',
    'offer_percent' => 'Persentase',
    'offer_amount' => 'Nominal',
    'offer_value' => 'Berapa potongannya',
    'offer_value_percent' => 'Persentase dari harga, jadi 20 berarti potong seperlima.',
    'offer_value_amount' => 'Nominal dalam mata uang toko, jadi 2,50 berarti potong dua setengah.',
    'offer_min' => 'Hanya mulai dari sekian barang',
    'offer_min_helper' => 'Seberapa penuh keranjang harus terisi sebelum diskonnya berlaku, dihitung dari semua isinya, bukan hanya paket ini. Nol atau satu berarti selalu berlaku. Dua adalah alasan untuk menaruh barang kedua.',
];
