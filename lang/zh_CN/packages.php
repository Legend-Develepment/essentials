...
return [
    ...
    'upgrade_to' => '可以换成',
    'upgrade_to_helper' => '这个套餐上一份正在用的服务，可以往上或往下换到哪些套餐。列出来的只有用同一个 egg 的套餐，因为换了 egg 就是另一台服务器，而不是一台更大的。一个都不勾，就是这个套餐换不出去。',
    'upgrade_to_none' => '还没有别的套餐用这个 egg。',
    ...
    'popular' => '指一指这一个',
    'popular_helper' => '把它标成多数人会挑的那一个。它在商店里往上挪，排在正在打折的东西下面，并带一个小标记。这不是关于销量的说法 - 只是店家伸手指了一下。',
    'offer' => '打折中',
    'offer_helper' => '把它挪到商店最前面并加上标记，同时按下面的折扣从它的价格里减掉。',
    'offer_kind' => '折扣方式',
    'offer_percent' => '按百分比',
    'offer_amount' => '按金额',
    'offer_value' => '减多少',
    'offer_value_percent' => '按价格的百分比算，所以 20 就是减掉五分之一。',
    'offer_value_amount' => '按商店货币算的金额，所以 2.50 就是从价格里减掉 2.50。',
    'offer_min' => '满这么多件才算',
    'offer_min_helper' => '购物车里要装到多满，折扣才生效，算的是里面的所有东西，不只是这个套餐。零或一就是一直生效。二就是一个再放一件进去的理由。',
];
