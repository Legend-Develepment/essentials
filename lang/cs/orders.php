...
return [
    ...
    'cancel' => 'Zrušit',
    'cancel_confirm' => 'Služba běží do :date a znovu se neúčtuje. Ten den se server smaže i se vším, co na něm je. Zákazník se obojí dozví teď.',
    'cancelled' => 'Zrušeno',
    ...
    'not_paid' => 'K téhle objednávce nepatří žádná zaplacená faktura, takže se nic nepostavilo. Pokud zaplacená byla, tak tuhle objednávku neuvádí - řekni to tomu, kdo tenhle panel spravuje.',
