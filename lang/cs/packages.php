...
return [
    ...
    'upgrade_to' => 'Lze změnit na',
    'upgrade_to_helper' => 'Na které balíčky se smí přesunout živá služba z tohoto, nahoru i dolů. Vypsané jsou jen balíčky se stejným eggem, protože jiný egg je jiný server, ne větší. Nic nezaškrtnutého znamená, že z tohoto balíčku přejít nejde.',
    'upgrade_to_none' => 'Tenhle egg zatím nepoužívá žádný jiný balíček.',
    ...
    'popular' => 'Ukázat na tenhle',
    'popular_helper' => 'Označí ho jako ten, který si lidé volí nejčastěji. V obchodě se posune výš, pod všechno, co je v akci, a nese malý štítek. Není to tvrzení o číslech prodeje - je to obchodník, který ukazuje prstem.',
    'offer' => 'V akci',
    'offer_helper' => 'Posune ho v obchodě dopředu se štítkem a odečte z jeho ceny slevu níže.',
    'offer_kind' => 'Sleva jako',
    'offer_percent' => 'Procenta',
    'offer_amount' => 'Částka',
    'offer_value' => 'O kolik méně',
    'offer_value_percent' => 'Procento z ceny, takže 20 znamená o pětinu méně.',
    'offer_value_amount' => 'Částka v měně obchodu, takže 2,50 znamená o dvě a půl méně.',
    'offer_min' => 'Až od tolika položek',
    'offer_min_helper' => 'Jak plný musí být košík, než se sleva uplatní, počítáno přes všechno v něm, ne jen přes tenhle balíček. Nula nebo jedna znamená vždycky. Dvojka je důvod přihodit ještě něco.',
];
