...
return [
    ...
    // ---- a táblázat ------------------------------------------------------
    'column_name' => 'Csomag',
    'column_flags' => 'Jelzések',
    'column_flags_from' => ':count tételtől',
    'column_egg' => 'Egg',
    'column_price' => 'Ár',
    ...
    'upgrade_to' => 'Erre cserélhető',
    'upgrade_to_helper' => 'Mely csomagokra mozgatható át egy ezen futó élő szolgáltatás, felfelé vagy lefelé. Csak az ugyanezt az egget használó csomagok szerepelnek, mert egy másik egg nem nagyobb szerver, hanem másik szerver. Semmi bejelölve azt jelenti: erről a csomagról nem lehet átváltani.',
    'upgrade_to_none' => 'Ezt az egget még egyetlen másik csomag sem használja.',
    ...
    'popular' => 'Mutass rá erre',
    'popular_helper' => 'Megjelöli, hogy ezt választják a legtöbben. Előrébb kerül a boltban, az akciós csomagok alá, és kap egy kis jelzést. Nem állítás az eladási számokról - egy boltos mutat rá.',
    'offer' => 'Akciós',
    'offer_helper' => 'A bolt elejére teszi egy jelzéssel, és levonja az árából az alábbi kedvezményt.',
    'offer_kind' => 'A kedvezmény formája',
    'offer_percent' => 'Százalék',
    'offer_amount' => 'Összeg',
    'offer_value' => 'Mennyi jön le',
    'offer_value_percent' => 'Az ár százaléka, tehát a 20 azt jelenti, hogy az ötöde jön le.',
    'offer_value_amount' => 'Összeg a bolt pénznemében, tehát a 2,50 azt jelenti, hogy két és fél jön le.',
    'offer_min' => 'Csak ennyi tételtől',
    'offer_min_helper' => 'Mennyire kell tele lennie a kosárnak ahhoz, hogy a kedvezmény érvényes legyen; minden beletett tétel számít, nem csak ez a csomag. A nulla vagy az egy azt jelenti, hogy mindig érvényes. A kettő ok arra, hogy még valamit betegyenek.',
];
