...
return [
    ...
    'cancel' => 'Lemondás',
    'cancel_confirm' => 'A szolgáltatás :date napjáig fut, és nem számlázzuk újra. Aznap a szerver törlődik, mindennel, ami rajta van. A vásárló most mindkettőről értesül.',
    'cancelled' => 'Lemondva',
    ...
    'not_paid' => 'Ehhez a rendeléshez nem tartozik kifizetett számla, így nem épült meg semmi. Ha mégis ki lett fizetve, akkor az a számla, amelyen kifizették, nem sorolja fel ezt a rendelést - szólj annak, aki ezt a panelt üzemelteti.',
    ...
    'by_customer' => 'A vásárló szüntette meg',
    'by_admin' => 'Itt szüntettük meg',
    'filter_by' => 'Ki szüntette meg',
    'details' => 'Részletek',
    'details_of' => 'Rendelés :number',
    'close' => 'Bezárás',
    'detail_package' => 'Csomag',
    'detail_placed' => 'Megrendelve',
    'detail_built' => 'Szerver megépítve',
    'detail_due' => 'Következő esedékesség',
    'detail_ends' => 'Véget ér',
    'detail_suspended' => 'Felfüggesztve',
    'detail_cancelled' => 'Lemondva',
    'detail_file_in' => 'Fájl bekerült',
    'detail_file_waiting' => 'Fájl',
    'detail_file_waiting_value' => 'Feltöltve, várja a szerver megépítését.',
    'detail_note' => 'Utolsó probléma',
