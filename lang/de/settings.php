...
return [
    ...
    'groups' => [
        ...
        'valheim' => 'Valheim',
        'languages' => 'Sprachen',
        'files_where' => 'Wo Dateien liegen',
        'files_bucket' => 'Der Bucket',
        'files_cdn' => 'Das CDN',
        'files_mirror' => 'Sprachen, außerhalb des Panels gehalten',
     ...
     */
    /*
     * Wo die Dateien liegen, die dieses Plugin führt.
     *
     * Die Worte handeln von einem Ziel und nicht von einem Anbieter, denn
     * dieselben drei Sätze gelten für einen Bucket wie für ein CDN, und wer so
     * etwas einrichtet, interessiert sich nicht dafür, welches von beiden er
     * gerade vor sich hat, bis die Felder sich unterscheiden.
     */
    'files' => [
        'where' => 'Dateien liegen',
        'where_helper' => 'Auf dem Panel liegen sie auf dessen eigener Festplatte, und dort sind sie immer gelandet; einzurichten ist dafür nichts. Alles andere ist ein Ort, an dem dieses Panel sie nicht halten muss, und wird näher an dem ausgeliefert, der hinsieht. Ein Ziel, das nicht antwortet, fällt auf das Panel zurück, statt einen Upload zu verlieren.',
        'panel' => 'Auf diesem Panel',
        's3' => 'In einem Bucket (S3, R2, MinIO, Wasabi)',
        'cdn' => 'Auf einem CDN',
        'read_from' => 'Gelesen von',
        'read_from_helper' => 'Wo eine Datei geholt wird, und das ist nicht immer dort, wo sie geschrieben wurde. Ein CDN vor einem Bucket gehört hierher, und ebenso eine Ausliefer-Adresse, die sich von der der API unterscheidet. Leer lässt es das Ziel selbst herausfinden.',
        ...
        'cdn_title' => 'Das CDN',
        'cdn_helper' => 'Ein CDN, das die Modora-API spricht. Das Token ist eines von Server zu Server und gilt als volles Admin-Recht auf diesem Konto, es bleibt deshalb aus einer exportierten Einstellungsdatei heraus, so wie alle anderen Zugangsdaten hier.',
        'cdn_base' => 'Adresse',
        'cdn_base_helper' => 'Wo die API liegt. Werden Dateien von woanders ausgeliefert, trag diese Adresse oben unter Gelesen von ein.',
        'cdn_token' => 'Token',
        'cdn_token_helper' => 'Wird als X-Internal-Token geschickt. Wer es hat, kann im ganzen Konto schreiben und löschen.',
        'cdn_folder' => 'Ordner',
        'cdn_folder_helper' => 'Ein Ordner unter dem Konto, in dem die Dateien dieses Panels liegen, damit ein CDN mehrere Panels bedienen kann, ohne dass sie sich in die Quere kommen.',

        'move' => 'Verschieben, was noch auf dem Panel liegt',
        'move_confirm' => 'Das Sidebar-Symbol, der Hintergrund des Panels und der Hintergrund der Anmeldung werden an das Ziel kopiert und ihre Adressen umgeschrieben. Die Kopien auf diesem Panel bleiben liegen, wo sie sind, es geht also nichts kaputt, wenn du es dir anders überlegst. Von hier an hochgeladene Bilder gehen ohnehin an das Ziel; das hier gilt nur für die, die schon hier sind.',
        'move_done' => 'Verschoben',
        'move_done_body' => 'Angesehen: :looked, verschoben: :moved, nicht zu verschieben: :failed.',
        'check' => 'Das hier testen',
        'check_ok' => 'Es funktioniert',
        'check_ok_body' => 'Eine Datei wurde geschrieben, über ihre öffentliche Adresse zurückgeholt und wieder entfernt.',
        'check_bad' => 'Das hat nicht funktioniert',
        'check_panel' => 'Dateien sollen auf diesem Panel liegen, es gibt also nichts zu testen.',
        'check_refused' => 'Das Ziel hat die Datei abgelehnt und nichts dazu gesagt, warum.',
        'check_unreadable' => 'Es hat die Datei genommen, aber von :url ließ sie sich nicht zurücklesen. Das ist die Adresse, die ein Browser nehmen wird, eine Datei, die niemand holen kann, ist später also ein kaputtes Bild. Prüf Gelesen von, und ob das Ziel Dateien öffentlich ausliefert.',
        'bucket_missing' => 'Schlüssel, Secret und Bucket-Name werden alle drei gebraucht, bevor es etwas zu testen gibt.',
        'cdn_missing' => 'Adresse und Token werden beide gebraucht, bevor es etwas zu testen gibt.',
        'cdn_shape' => 'Es hat die Datei angenommen und dann in einer Form geantwortet, in der dieses Panel keine Adresse finden konnte. Gesagt hat es: :body',
        'mirror_minutes' => 'Nach geänderten Sprachen sehen alle',
        'mirror_minutes_helper' => 'In Minuten. Nachsehen ist billig: jede hochgeladene Sprache wird gelesen, gehasht und mit dem verglichen, was zuletzt geschickt wurde, ein gewöhnlicher Durchlauf schickt also gar nichts. Nur eine Sprache, die jemand geändert hat, geht über die Leitung.',
        'mirror_now' => 'Sprachen jetzt kopieren',
        'mirror_done' => 'Sprachen kopiert',
        'mirror_done_body' => 'Angesehen: :looked, geschickt: :sent, nicht zu schicken: :failed.',
        'mirror_restore' => 'Sprachen zurückholen',
        'mirror_restore_confirm' => 'Das schreibt jede Sprache aus der Kopie außerhalb des Panels über das, was auf diesem Panel liegt. Nach einer Aktualisierung ist genau das der Sinn, und eine installierte Sprache lässt sich danach nicht wieder entfernen - es lohnt sich also, sicher zu sein.',
        'mirror_back' => 'Sprachen zurückgeholt',
        'mirror_back_body' => 'Gefunden: :found, zurückgelegt: :put, nicht zu holen: :failed.',
    ],
    ...
    'pages' => [
        ...
        'files' => 'Speicher und CDN',
        'files_helper' => 'Wo die Dateien liegen, die dieses Plugin führt, und von welcher Adresse sie gelesen werden.',
    ],
    ...
    'features' => [
        ...
        'console' => 'Konsolenschaltfläche',
        'console_helper' => 'Die schwebende Schaltfläche innerhalb eines Servers, mit der Konsole und den Ein/Aus-Schaltflächen darauf, die die Node direkt erreicht. Welche Gestalt sie annimmt, steht in den Seiten-Einstellungen; hier wird entschieden, ob sie überhaupt gezeichnet wird.',
        'arranger' => 'Seiten anordnen',
        'arranger_helper' => 'Die Blöcke einer Seite in die Reihenfolge ziehen, die jemand haben will. Es trägt eine eigene Berechtigung unter Rollen, hier wird also entschieden, ob das Panel es anbietet, und die Berechtigung entscheidet, wem.',
        'user_themes' => 'Stile je Person',
        'user_themes_helper' => 'Jeden für sich einen Stil aus denen wählen lassen, die du anbietest, unter Darstellung im Kundenbereich. Welche Stile angeboten werden, steht auf der Aussehen-Seite; hier wird entschieden, ob überhaupt jemand gefragt wird.',
        'api' => 'API',
        ...
        'files' => 'Speicher und CDN',
        'files_helper' => 'Die Dateien dieses Plugins woanders als auf dem Panel halten: in einem S3-Bucket oder auf einem CDN. Aus heißt nicht „keine Dateien" - es heißt die eigene Festplatte des Panels, und dort sind sie immer gelandet. Entschieden wird hier, ob überhaupt etwas anderes angeboten wird. Ein Ziel, das nicht antwortet, fällt auf das Panel zurück, statt einen Upload zu verlieren, und eine bereits festgehaltene Adresse wird nie zurückgenommen: diese Einstellung entscheidet, wohin die nächste Datei geht, nicht, wo die letzte liegt.',
        'minecraft' => 'Minecraft',
        ...
        'updating' => 'Hinweis während der Aktualisierung',
        'waitlist' => 'Warteliste',
        'waitlist_helper' => 'Jemanden bitten lassen, dass ihm gesagt wird, wenn ein ausverkauftes Paket wieder zu haben ist. Kommt der Bestand zurück, erfahren es alle, die auf dieses Paket warten, gleichzeitig, und es bekommt, wer zuerst kauft - für niemanden wird etwas zurückgelegt, und jede Meldung sagt das. Der Hinweis nimmt sie von der Liste, ein Fragen kauft also einen Hinweis und nie ein stehendes Abonnement. Es braucht den Shop, und es ist das eine im Shop, das einem Kunden schreibt, der nichts gekauft hat.',
        'updating_helper' => 'Eine Zeile oben auf der Seite, während dieses Plugin eine Aktualisierung installiert, und fünf Minuten, nachdem sie fertig ist. Während der Aktualisierung selbst lässt sie sich nicht zeigen - solange die Version getauscht wird, liest Pelican dieses Plugin als nicht installiert und lädt nichts davon, es bleibt also nichts von uns übrig, womit sich zeichnen ließe. Gedacht ist sie für den, der eine halb gezeichnete Seite antraf, wartete und wiederkam: die Zeile sagt ihm, was er gesehen hat.',
        ...
        'credit' => 'Guthaben und Erstattungen',
        'credit_helper' => 'Geld, das der Shop für einen Kunden hält. Eine Erstattung kann zurück auf die Karte gehen, von der sie kam, oder als Guthaben auf dem Konto bleiben; in beiden Fällen wird eine Gutschrift geschrieben, und Guthaben auf einem Konto geht von selbst von der nächsten Rechnung ab, bevor der Kunde überhaupt um Zahlung gebeten wird. Eigenes Recht, denn eine Rechnung als bezahlt zu markieren hält fest, dass Geld angekommen ist, und das hier gibt Geld heraus.',
        'upgrades' => 'Hochstufen und Herabstufen',
        'upgrades_helper' => 'Einen laufenden Dienst auf ein anderes Paket bringen, ohne ein neues zu kaufen. Was von der bereits bezahlten Periode übrig ist, kommt zurück, dieselbe Strecke wird zum neuen Preis berechnet, und die Differenz wird in Rechnung gestellt oder auf das Konto des Kunden gelegt. Jedes Paket führt auf, auf welche anderen es wechseln darf, und angeboten werden nur solche mit demselben Egg: ein anderes Egg ist ein anderer Server und kein größerer.',
        'addons' => 'Extras',
        'addons_helper' => 'Dinge, die neben einem Paket verkauft werden: mehr Speicher, noch ein Backup-Slot, oder etwas, das nur eine Zeile auf der Rechnung ist. Jedes sagt, zu welchen Paketen es passt und was es dem Server hinzufügt, und es wird entweder bei jeder Verlängerung oder einmalig berechnet. Gekauft an der Kasse oder später an einem laufenden Dienst, wo es auf den Rest der Periode umgerechnet wird. Eigenes Recht, denn was ein Extra dem Server von jemandem hinzufügen darf, ist eine Entscheidung über seine Maschine und nicht über eine Preisliste.',
        'tickets' => 'Tickets',
        'tickets_helper' => 'Ein Ort, an dem Kunden von innerhalb des Panels fragen können, neben dem Dienst, um den es geht - und das ist das eine, was ein Chat-Kanal nicht kann. Beantwortet auf einer Seite hier oder über Modora an Discord gegeben, je nachdem, worauf die Ticket-Seite steht. Jede Frage und jede Antwort bleibt so oder so in diesem Panel, es geht also nichts verloren, wenn die Gegenseite nicht erreichbar ist. Eigenes Recht, denn Kunden zu antworten ist eine Aufgabe, die jemand bekommt, und keine, die mit dem Bepreisen von Paketen einhergeht.',
        'overview' => 'Shop-Übersicht',
        'overview_helper' => 'Die Seite, die beantwortet, was diesen Monat hereinkam, was offen ist, was die aktiven Dienste jeden Monat wert sind und was heute Aufmerksamkeit braucht. Eigenes Recht, denn der Umsatz ist nichts, was jeder lesen können sollte, der ein Paket bepreisen darf.',
        'terminate' => 'Einen Dienst beenden',
        'terminate_helper' => 'Die Schaltfläche, die einen Dienst sofort anhält und seinen Server löscht, mit Dateien und allem. Absichtlich vom Recht auf Bestellungen getrennt: Sperren, eine Fälligkeit verschieben und Stornieren lassen sich alle rückgängig machen, dieses hier nicht. Wer Tickets beantwortet, kann die ersten drei haben, ohne dieses zu haben.',
    ...
    'channel' => [
        ...
        'token' => 'Token des Dev-Repositorys',
        'token_helper' => 'Der Dev-Kanal wird aus einem privaten Repository veröffentlicht, zum Lesen braucht es also ein GitHub-Token - ein fein abgestuftes persönliches Zugriffstoken mit Lesezugriff auf die Inhalte dieses Repositorys und sonst nichts. Stabil und Beta sind öffentlich und brauchen keines. Es bleibt auf diesem Panel: in eine exportierte Einstellungsdatei wird es nicht geschrieben.',
        'stable' => 'Stabil',
        'beta' => 'Beta',
