...
return [
    ...
    'cancel' => 'Annuleren',
    'cancel_confirm' => 'De dienst loopt tot :date en wordt niet opnieuw gefactureerd. Op die dag wordt de server verwijderd, met alles wat erop staat. De klant hoort beide, nu.',
    ...
    'not_paid' => 'Bij deze bestelling hoort geen betaalde factuur, dus er is niets gebouwd. Is er wel betaald, dan noemt die factuur deze bestelling niet - meld het bij wie dit panel beheert.',
    ...
    'by_customer' => 'Beëindigd door de klant',
    'by_admin' => 'Hier beëindigd',
    'filter_by' => 'Wie het beëindigde',
    'details' => 'Details',
    'details_of' => 'Bestelling :number',
    'close' => 'Sluiten',
    'detail_package' => 'Pakket',
    'detail_placed' => 'Besteld',
    'detail_built' => 'Server gebouwd',
    'detail_due' => 'Volgende termijn',
    'detail_ends' => 'Loopt af',
    'detail_suspended' => 'Stilgezet',
    'detail_cancelled' => 'Geannuleerd',
    'detail_file_in' => 'Bestand erin gezet',
    'detail_file_waiting' => 'Bestand',
    'detail_file_waiting_value' => 'Geüpload, wacht tot de server gebouwd is.',
    'detail_note' => 'Laatste probleem',
