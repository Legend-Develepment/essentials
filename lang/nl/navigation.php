 ...
 *
 * 'favicon' staat in het Engels tussen dubbele aanhalingstekens omdat er een
 * apostrof in de tekst zit. Hier is dat niet nodig, dus enkele.
 */
...
return [
    ...
    'scope_login' => 'Onder het inlogformulier',

    'group' => 'Groep',
    'group_helper' => 'Laat leeg om hem boven het eerste kopje te zetten. Typ bij twee links dezelfde naam en ze komen er samen onder te staan.',
    ...
    'failed' => 'De navigatielinks konden niet worden opgeslagen',
];
