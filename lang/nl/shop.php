...
return [
    ...
    'leave_as_is' => 'Laten zoals het is',
    'asks_optional' => 'Dit hoeft allemaal niet. Wat je laat staan, houdt wat het serversjabloon al had.',
    ...
    'renews' => 'Verlengt',
    'server_installing' => 'Wordt nog klaargemaakt. Hij start vanzelf zodra dat klaar is.',
    'server_failed' => 'Het klaarmaken is niet afgerond. Wie dit paneel beheert, weet ervan.',
    'server_suspended' => 'Stilgezet door het paneel. Alles wat erop staat, staat er nog.',
    ...
    'give_now' => 'Nu stoppen en verwijderen',
    'give_now_confirm' => 'Deze server nu verwijderen, met zijn bestanden, zijn databases en zijn back-ups? Er is geen ongedaan maken, en geen geld terug voor de rest van de periode die je betaald hebt.',
    'gave_end' => 'Opgezegd',
    'gave_end_body' => 'Hij loopt tot de datum op de kaart en wordt niet meer gefactureerd. Er wordt niets verwijderd voor die tijd.',
    'gave_now' => 'Weg',
    'gave_now_body' => 'De server is verwijderd en je krijgt er geen factuur meer voor.',
    'gave_refused' => 'Dat is niet gelukt',
    'gave_refused_body' => 'Er is niets veranderd. Ververs de pagina, en vraag het aan wie dit paneel beheert als het blijft gebeuren.',
    ...
    'self_cancel' => 'Laat klanten hun eigen dienst beëindigen',
    'self_cancel_helper' => 'Twee uitgangen op hun dienstenpagina: beëindigen op de contractdatum, wat de facturen stopt en de server verwijdert op de dag die ze gehoord hebben, of nu stoppen, wat hem meteen verwijdert. Het zijn dezelfde knoppen die je op de pagina Bestellingen hebt. Uit wordt geen van beide aangeboden en moeten ze het beëindigen aan jou vragen.',
];
