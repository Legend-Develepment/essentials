...
return [
    ...
    // ---- tabelul ---------------------------------------------------------
    'column_name' => 'Pachet',
    'column_flags' => 'Etichete',
    'column_flags_from' => 'de la :count',
    'column_egg' => 'Egg',
    'column_price' => 'Preț',
    'column_stock' => 'Stoc',
    ...
    'delete_confirm_sold' => 'S-a vândut de :count ori. Serviciile acelea nu sunt atinse: o comandă poartă propria copie a tot ce i s-a vândut, așa că serverele merg mai departe, iar facturile spun în continuare ce s-a cumpărat. Dispare doar imaginea de pe cardul serviciului lor, iar pachetul nu mai este de vânzare.',
    ...
    'deleted_sold' => 'Cele :count servicii vândute din el sunt neatinse și merg mai departe.',
    'saved' => 'Pachet salvat',
    ...
    'upgrade_to' => 'Se poate schimba în',
    'upgrade_to_helper' => 'În ce pachete poate fi mutat, în sus sau în jos, un serviciu activ de pe acesta. Sunt listate doar pachetele care folosesc același egg, pentru că un alt egg înseamnă alt server, nu unul mai mare. Nimic bifat înseamnă că de pe acest pachet nu se poate schimba nicăieri.',
    'upgrade_to_none' => 'Niciun alt pachet nu folosește încă acest egg.',
    ...
    'popular' => 'Arată spre acesta',
    'popular_helper' => 'Îl marchează drept cel pe care îl aleg cei mai mulți. Urcă în magazin, sub tot ce este la ofertă, și primește o etichetă mică. Nu este o afirmație despre cifrele de vânzări - un negustor care arată cu degetul.',
    'offer' => 'La ofertă',
    'offer_helper' => 'Îl duce în fața magazinului cu o etichetă pe el și scade din prețul lui reducerea de mai jos.',
    'offer_kind' => 'Reducerea ca',
    'offer_percent' => 'Un procent',
    'offer_amount' => 'O sumă',
    'offer_value' => 'Cât se scade',
    'offer_value_percent' => 'Un procent din preț, deci 20 înseamnă o cincime mai puțin.',
    'offer_value_amount' => 'O sumă în moneda magazinului, deci 2,50 înseamnă doi și jumătate mai puțin.',
    'offer_min' => 'Doar de la atâtea articole',
    'offer_min_helper' => 'Cât de plin trebuie să fie coșul înainte ca reducerea să se aplice, numărând tot ce este în el, nu doar acest pachet. Zero sau unu înseamnă că se aplică mereu. Doi este un motiv să mai pui ceva în coș.',
];
