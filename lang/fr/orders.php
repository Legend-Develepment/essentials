...
return [
    ...
    'cancel' => 'Annuler',
    'cancel_confirm' => 'Le service tourne jusqu’au :date et n’est plus facturé. Ce jour-là le serveur est supprimé, avec tout ce qu’il contient. Le client est prévenu des deux, maintenant.',
    'cancelled' => 'Annulée',
    ...
    'not_paid' => 'Cette commande n\'a aucune facture payée, donc rien n\'a été construit. Si elle a bien été payée, la facture sur laquelle elle a été réglée ne mentionne pas cette commande - signalez-le à qui gère ce panel.',
    ...
    'by_customer' => 'Terminé par le client',
    'by_admin' => 'Terminé ici',
    'filter_by' => 'Qui a terminé',
    'details' => 'Détails',
    'details_of' => 'Commande :number',
    'close' => 'Fermer',
    'detail_package' => 'Formule',
    'detail_placed' => 'Commandée',
    'detail_built' => 'Serveur construit',
    'detail_due' => 'Prochaine échéance',
    'detail_ends' => 'Prend fin',
    'detail_suspended' => 'Suspendu',
    'detail_cancelled' => 'Annulé',
    'detail_file_in' => 'Fichier placé',
    'detail_file_waiting' => 'Fichier',
    'detail_file_waiting_value' => 'Envoyé, en attente de la construction du serveur.',
    'detail_note' => 'Dernier problème',
