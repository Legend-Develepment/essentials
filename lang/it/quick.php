...
return [
    // ---- il controllo nella barra in alto --------------------------------
    'label' => 'Vai a',
    'open' => 'Vai a un server o a una pagina contrassegnata',
    'search' => 'Cerca server…',
    ...
    'title' => 'Preferiti',
    'nav_label' => 'Preferiti',
    'subheading' => 'Tutto quello che hai contrassegnato, in un posto solo.',

    'how' => 'Contrassegna un server con la stella sulla sua scheda nella lista dei server, e una pagina con il pulsante nel menu «Vai a», in cima allo schermo. La tua lista è tenuta sul pannello e non in questo browser, quindi ti segue ovunque accederai la prossima volta.',
    'page_empty' => 'Non c\'è ancora nulla di contrassegnato.',
    'remove' => 'Togli dai preferiti',
];
