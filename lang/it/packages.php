...
return [
    ...
    'column_flags' => 'Contrassegni',
    'column_flags_from' => 'da :count',
    'column_egg' => 'Egg',
    'column_price' => 'Prezzo',
    ...
    'delete_confirm_sold' => 'È stato venduto :count volte. Quei servizi non vengono toccati: un ordine porta con sé la propria copia di tutto ciò con cui è stato venduto, quindi i server continuano a funzionare e le fatture continuano a dire che cosa è stato comprato. Sparisce solo l\'immagine sulla scheda del loro servizio, e il pacchetto non è più in vendita.',
    ...
    'deleted_sold' => 'I :count servizi venduti da questo pacchetto restano intatti e continuano a funzionare.',
    ...
    'upgrade_to' => 'Può essere cambiato in',
    'upgrade_to_helper' => 'In quali pacchetti può essere spostato un servizio attivo su questo, verso l\'alto o verso il basso. Sono elencati solo i pacchetti che usano lo stesso egg, perché un egg diverso è un server diverso e non uno più grande. Niente spuntato significa che da questo pacchetto non si può cambiare.',
    'upgrade_to_none' => 'Nessun altro pacchetto usa ancora questo egg.',
    ...
    'section_ask' => 'Chiedi al cliente',
    'section_ask_helper' => 'Domande messe alla cassa, a cui si risponde prima di inviare l\'ordine. Le risposte arrivano al server quando viene creato.',
    'ask_vars' => 'Variabili da chiedere',
    'ask_vars_helper' => 'Le variabili dell\'egg. Spuntane una e il cliente la compila mentre compra, e la sua risposta viene usata al posto del valore di questo pacchetto. Non spuntare niente e non viene chiesto nulla a nessuno.',
    'upload_ask' => 'Chiedi un file',
    'upload_ask_helper' => 'Uno zip che il cliente carica mentre compra - un mondo, un modpack, una serie di configurazioni. Viene messo nel suo server quando viene creato, prima che gli si dica che è pronto.',
    'upload_label' => 'Come chiamarlo',
    'upload_label_helper' => 'L\'etichetta sopra il campo del file, con parole tue. Vuoto ne usa una semplice.',
    'upload_dir' => 'Dove nel server',
    'upload_dir_helper' => 'Un percorso dentro il server, come / oppure /world. Viene reso sicuro prima di essere usato.',
    'upload_extract' => 'Scompattalo',
    'upload_extract_helper' => 'Attivo, lo zip viene scompattato dove arriva e l\'archivio stesso rimosso - giusto per un mondo o per una serie di configurazioni. Disattivato, lo zip resta un file, che è quello che vuole un egg che da uno zip installa un modpack.',
    'empty_body' => 'Creane uno e appare nel negozio non appena viene messo in vendita.',
    'popular' => 'Indica questo',
    'popular_helper' => 'Lo segna come quello che sceglie la maggior parte della gente. Sale nel negozio, sotto a tutto ciò che è in offerta, e porta un piccolo contrassegno. Non è un\'affermazione sui numeri di vendita - è un negoziante che indica.',
    'offer' => 'In offerta',
    'offer_helper' => 'Lo porta in cima al negozio con un contrassegno sopra, e toglie dal suo prezzo lo sconto qui sotto.',
    'offer_kind' => 'Sconto come',
    'offer_percent' => 'Una percentuale',
    'offer_amount' => 'Un importo',
    'offer_value' => 'Quanto di sconto',
    'offer_value_percent' => 'Una percentuale del prezzo, quindi 20 significa un quinto in meno.',
    'offer_value_amount' => 'Un importo nella valuta del negozio, quindi 2,50 significa due e cinquanta in meno.',
    'offer_min' => 'Solo da questo numero di articoli',
    'offer_min_helper' => 'Quanto deve essere pieno il carrello prima che lo sconto valga, contando tutto quello che c\'è dentro e non solo questo pacchetto. Zero o uno significa che vale sempre. Due è un motivo per metterci una seconda cosa.',
];
