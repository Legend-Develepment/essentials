...
return [
    ...
    'cancel' => 'Avbestill',
    'cancel_confirm' => 'Tjenesten kjører til :date og faktureres ikke på nytt. Den dagen slettes serveren med alt som ligger på den. Kunden får vite begge deler nå.',
    'cancelled' => 'Avbestilt',
    ...
    'not_paid' => 'Denne bestillingen har ingen betalt faktura, så ingenting ble bygget. Er den betalt, nevner ikke fakturaen den ble betalt på denne bestillingen - si fra til den som driver panelet.',
    ...
    'by_customer' => 'Avsluttet av kunden',
    'by_admin' => 'Avsluttet her',
    'filter_by' => 'Hvem avsluttet',
    'details' => 'Detaljer',
    'details_of' => 'Bestilling :number',
    'close' => 'Lukk',
    'detail_package' => 'Pakke',
    'detail_placed' => 'Bestilt',
    'detail_built' => 'Server bygget',
    'detail_due' => 'Neste forfall',
    'detail_ends' => 'Avsluttes',
    'detail_suspended' => 'Suspendert',
    'detail_cancelled' => 'Avbestilt',
    'detail_file_in' => 'Fil lagt inn',
    'detail_file_waiting' => 'Fil',
    'detail_file_waiting_value' => 'Lastet opp, venter på at serveren skal bygges.',
    'detail_note' => 'Siste problem',
