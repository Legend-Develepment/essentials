...
return [
    ...
    'delete_confirm_sold' => 'Denne er solgt :count gang(er). De tjenestene røres ikke: en ordre bærer sin egen kopi av alt den ble solgt med, så serverne fortsetter å gå og fakturaene fortsetter å si hva som ble kjøpt. Bare bildet på tjenestekortet deres forsvinner, og pakken går av salg.',
    ...
    'deleted_sold' => 'De :count tjeneste(r) som ble solgt fra den, er urørt og går fortsatt.',
    'saved' => 'Pakke lagret',
    ...
    'upgrade_to' => 'Kan byttes til',
    'upgrade_to_helper' => 'Hvilke pakker en tjeneste som går på denne, kan flyttes til, opp eller ned. Bare pakker som bruker det samme egget, står i listen, for et annet egg er en annen server framfor en større. Ingenting avkrysset betyr at det ikke kan byttes bort fra denne pakken.',
    'upgrade_to_none' => 'Ingen annen pakke bruker dette egget ennå.',
    ...
    'popular' => 'Pek på denne',
    'popular_helper' => 'Merker den som den de fleste velger. Den flytter seg opp i butikken, under alt som er på tilbud, og får et lite flagg. Ingen påstand om salgstall - en butikkeier som peker.',
    'offer' => 'På tilbud',
    'offer_helper' => 'Setter den fremst i butikken med et flagg på, og tar rabatten nedenfor av prisen.',
    'offer_kind' => 'Rabatt som',
    'offer_percent' => 'En prosentdel',
    'offer_amount' => 'Et beløp',
    'offer_value' => 'Hvor mye i rabatt',
    'offer_value_percent' => 'En prosentdel av prisen, så 20 betyr en femtedel i rabatt.',
    'offer_value_amount' => 'Et beløp i butikkens valuta, så 2,50 betyr to og en halv i rabatt.',
    'offer_min' => 'Først fra så mange varer',
    'offer_min_helper' => 'Hvor full handlekurven må være før rabatten gjelder, regnet over alt som ligger i den og ikke bare over denne pakken. Null eller én betyr alltid. To er en grunn til å legge en ting til.',
];
