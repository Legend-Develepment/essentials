...
return [
    ...
    'kind_credit' => 'Faktura korygująca',
    'kind_upgrade' => 'Zmiana pakietu',
    'kind_topup' => 'Doładowanie środków',
    'kind_addon' => 'Dodatek',
    ...
    'order_count' => 'usługi: :count',
    'no_due' => 'Bez daty',
    'gone_customer' => 'Konto usunięte',
    'discount_of' => ':amount rabatu z kodem :code',
    'paid_via' => 'przez :how',
    'column_attempts' => 'Płatność',
    'paid_by' => 'zapłacone: :how',
    'paid_by_unknown' => 'zapłacone',
    'paid_by_manual' => 'ręcznie',
    'paid_by_free' => 'nie było nic do zapłaty',
    'attempts_none' => 'brak próby',
    'attempts_open' => 'prób: :count - :how',
    'attempt_last' => 'ostatnia :when, :state',
    'attempt_open' => 'nieukończona',
    'attempt_paid' => 'opłacona',
    'attempt_cancelled' => 'anulowana',
    'attempt_failed' => 'nieudana',
    'emailed' => 'Wysłana',
