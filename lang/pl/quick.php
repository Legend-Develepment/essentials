...
return [
    // ---- element na górnym pasku -----------------------------------------
    'label' => 'Przejdź do',
    'open' => 'Przejdź do serwera albo do oznaczonej strony',
    'search' => 'Szukaj serwerów…',
    ...
    'title' => 'Ulubione',
    'nav_label' => 'Ulubione',
    'subheading' => 'Wszystko, co oznaczyłeś, w jednym miejscu.',

    'how' => 'Serwer oznaczasz gwiazdką na jego karcie na liście serwerów, a stronę przyciskiem w menu „Przejdź do", na górze ekranu. Twoja lista jest trzymana w panelu, a nie w tej przeglądarce, więc idzie z Tobą tam, gdzie następnym razem się zalogujesz.',
    'page_empty' => 'Nic jeszcze nie jest oznaczone.',
