...
return [
    ...
    'cancel' => 'Anuluj',
    'cancel_confirm' => 'Usługa działa do :date i nie jest już fakturowana. Tego dnia serwer zostaje usunięty razem ze wszystkim, co na nim jest. Klient dowiaduje się teraz o obu rzeczach.',
    'cancelled' => 'Anulowane',
    ...
    'not_paid' => 'Do tego zamówienia nie ma opłaconej faktury, więc nic nie zostało zbudowane. Jeśli zapłata była, to faktura, na której ją zapłacono, nie wymienia tego zamówienia - powiedz o tym osobie, która prowadzi ten panel.',
