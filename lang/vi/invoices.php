...
return [
    ...
    'kind_credit' => 'Phiếu ghi có',
    'kind_upgrade' => 'Đổi gói',
    'kind_topup' => 'Nạp số dư',
    'kind_addon' => 'Tiện ích thêm',
    ...
    'order_count' => ':count dịch vụ',
    'no_due' => 'Không có ngày',
    'gone_customer' => 'Tài khoản đã xóa',
    'discount_of' => 'Giảm :amount với mã :code',
    'paid_via' => 'qua :how',
    'column_attempts' => 'Thanh toán',
    'paid_by' => 'đã trả - :how',
    'paid_by_unknown' => 'không rõ',
    'paid_by_manual' => 'ghi tay',
    'paid_by_free' => 'không phải trả gì',
    'attempts_none' => 'chưa thử lần nào',
    'attempts_open' => 'đã thử :count lần - :how',
    'attempt_last' => 'lần cuối :when, :state',
    'attempt_open' => 'chưa xong',
    'attempt_paid' => 'đã trả',
    'attempt_cancelled' => 'đã hủy',
    'attempt_failed' => 'hỏng',
    'emailed' => 'Đã gửi',
