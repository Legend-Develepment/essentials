...
return [
    ...
    'delete_confirm_sold' => 'Gói này đã bán :count lần. Những dịch vụ ấy không bị đụng tới: mỗi đơn hàng giữ bản sao riêng về mọi thứ đã bán kèm nó, nên các máy chủ vẫn chạy và hóa đơn vẫn nói rõ đã mua những gì. Chỉ mất tấm ảnh trên thẻ dịch vụ của họ, còn gói thì thôi không bán nữa.',
    ...
    'deleted' => 'Đã xóa gói',
    'deleted_sold' => ':count dịch vụ đã bán từ gói này vẫn nguyên vẹn và vẫn đang chạy.',
    'saved' => 'Đã lưu gói',
    ...
    'upgrade_to' => 'Có thể đổi sang',
    'upgrade_to_helper' => 'Một dịch vụ đang chạy trên gói này được phép chuyển sang những gói nào, lên hay xuống. Chỉ những gói dùng cùng một egg mới được liệt kê, bởi vì một egg khác là một máy chủ khác chứ không phải một máy chủ to hơn. Không đánh dấu gì nghĩa là từ gói này không đổi đi đâu được.',
    'upgrade_to_none' => 'Chưa có gói nào khác dùng egg này.',
    ...
    'popular' => 'Chỉ vào gói này',
    'popular_helper' => 'Đánh dấu đây là gói phần đông chọn. Nó lên cao hơn trong cửa hàng, dưới những gói đang giảm giá, và mang một cái cờ nhỏ. Không phải một lời khẳng định về doanh số - chỉ là người bán hàng chỉ tay.',
    'offer' => 'Đang giảm giá',
    'offer_helper' => 'Đưa nó lên đầu cửa hàng kèm một cái cờ, và trừ phần giảm giá bên dưới khỏi giá của nó.',
    'offer_kind' => 'Giảm theo',
    'offer_percent' => 'Phần trăm',
    'offer_amount' => 'Số tiền',
    'offer_value' => 'Giảm bao nhiêu',
    'offer_value_percent' => 'Một phần trăm của giá, nên 20 nghĩa là bớt một phần năm.',
    'offer_value_amount' => 'Một số tiền theo đơn vị tiền của cửa hàng, nên 2.50 nghĩa là bớt hai rưỡi.',
    'offer_min' => 'Chỉ áp dụng từ bấy nhiêu món',
    'offer_min_helper' => 'Giỏ hàng phải đầy tới đâu thì phần giảm mới được tính, đếm mọi thứ trong giỏ chứ không riêng gói này. Không hay một nghĩa là lúc nào cũng áp dụng. Hai là một lý do để bỏ thêm món thứ hai vào.',
];
