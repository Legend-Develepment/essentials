...
return [
    ...
    'cancel' => 'Hủy',
    'cancel_confirm' => 'Dịch vụ chạy đến :date và không bị tính phí lại. Ngày đó máy chủ bị xóa cùng mọi thứ trên nó. Khách được báo cả hai điều ngay bây giờ.',
    'cancelled' => 'Đã hủy',
    ...
    'not_paid' => 'Đơn hàng này không có hóa đơn nào đã trả, nên không có gì được dựng. Nếu nó đã được trả thì hóa đơn trả nó không liệt kê đơn hàng này - hãy báo cho người quản lý bảng điều khiển này.',
    ...
    'by_customer' => 'Khách tự kết thúc',
    'by_admin' => 'Kết thúc tại đây',
    'filter_by' => 'Ai kết thúc',
    'details' => 'Chi tiết',
    'details_of' => 'Đơn hàng :number',
    'close' => 'Đóng',
    'detail_package' => 'Gói',
    'detail_placed' => 'Đã đặt',
    'detail_built' => 'Máy chủ đã dựng',
    'detail_due' => 'Kỳ hạn kế',
    'detail_ends' => 'Kết thúc',
    'detail_suspended' => 'Đã dừng',
    'detail_cancelled' => 'Đã hủy',
    'detail_file_in' => 'Tệp đã đưa vào',
    'detail_file_waiting' => 'Tệp',
    'detail_file_waiting_value' => 'Đã tải lên, đang chờ dựng máy chủ.',
    'detail_note' => 'Sự cố gần nhất',
