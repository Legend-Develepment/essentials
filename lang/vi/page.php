...
return [
    'updating_now' => 'Bảng điều khiển này đang cài một bản cập nhật. Một trang có thể trông lạ trong chốc lát.',
    'updating_done' => 'Bản cập nhật đã được cài. Nếu vừa nãy có trang nào trông lạ, hãy tải lại nó.',
    ...
    'cron_missing' => 'Bộ lập lịch của bảng điều khiển đã :for phút không chạy. Gia hạn, kiểm tra watchdog và cập nhật tự động đều chờ vào nó. Dòng cron nằm trong tài liệu của Pelican.',
