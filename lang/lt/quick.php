 ...
 *
 * Viršutinės juostos perjungiklis ir puslapis, į kurį jis veda.
 *
 * Vienas valdiklis, atsakantis į du nuolat keliamus klausimus - kuris serveris,
 * ir kur buvo tos nuostatos - ir puslapis, išvardijantis viską, ką kas nors
 * pažymėjo žvaigždute. Žr. Support\Quick.
 */

return [
    // ---- valdiklis viršutinėje juostoje ----------------------------------
    'label' => 'Eiti į',
    'open' => 'Eiti į serverį arba į pažymėtą puslapį',
    'search' => 'Ieškoti serverių…',
