...
return [
    ...
    'cancel' => 'Atšaukti',
    'cancel_confirm' => 'Paslauga veikia iki :date ir daugiau nebeapmokestinama. Tą dieną serveris ištrinamas su viskuo, kas jame yra. Klientui apie abu dalykus pranešama dabar.',
    'cancelled' => 'Atšauktas',
    ...
    'not_paid' => 'Šis užsakymas neturi apmokėtos sąskaitos, tad nieko nebuvo sukurta. Jei buvo sumokėta, toje sąskaitoje, už kurią sumokėta, šis užsakymas nenurodytas - pasakykite tam, kas prižiūri šį skydelį.',
    ...
    'by_customer' => 'Užbaigė klientas',
    'by_admin' => 'Užbaigėme patys',
    'filter_by' => 'Kas jį užbaigė',
    'details' => 'Išsamiau',
    'details_of' => 'Užsakymas :number',
    'close' => 'Uždaryti',
    'detail_package' => 'Paketas',
    'detail_placed' => 'Užsakyta',
    'detail_built' => 'Serveris sukurtas',
    'detail_due' => 'Kitas terminas',
    'detail_ends' => 'Baigiasi',
    'detail_suspended' => 'Sustabdytas',
    'detail_cancelled' => 'Atšauktas',
    'detail_file_in' => 'Failas įdėtas',
    'detail_file_waiting' => 'Failas',
    'detail_file_waiting_value' => 'Įkeltas, laukiama, kol serveris bus sukurtas.',
    'detail_note' => 'Paskutinė problema',
