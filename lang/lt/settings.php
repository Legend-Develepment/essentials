...
return [
    ...
    'groups' => [
        ...
        'valheim' => 'Valheim',
        'languages' => 'Kalbos',
        'files_where' => 'Kur laikomi failai',
        'files_bucket' => 'Bucket',
        'files_cdn' => 'CDN',
        'files_mirror' => 'Kalbos, laikomos ne skydelyje',
     ...
     */
    /*
     * Kur dedami failai, kuriuos laiko šis papildinys.
     *
     * Žodžiai yra apie kryptį, o ne apie tiekėją, nes tie patys trys sakiniai
     * teisingi ir apie bucket, ir apie CDN, o administratoriui, kuris tai
     * nustatinėja, nerūpi, į kurį iš jų žiūri, kol laukai nesiskiria.
     */
    'files' => [
        'where' => 'Failai laikomi',
        'where_helper' => 'Skydelyje jie guli jo paties diske - ten, kur visada ir eidavo, ir nieko nustatyti nereikia. Bet kur kitur yra vieta, kurios šiam skydeliui laikyti nebereikia, ir ji pateikiama arčiau to, kas žiūri. Kryptis, kuri neatsako, atsitraukia į skydelį, o ne pameta įkeltą failą.',
        'panel' => 'Šiame skydelyje',
        's3' => 'Bucket viduje (S3, R2, MinIO, Wasabi)',
        'cdn' => 'CDN',
        'read_from' => 'Skaitoma iš',
        'read_from_helper' => 'Iš kur failas paimamas, o tai ne visada ten, kur jis buvo įrašytas. CDN, stovintis prieš bucket, rašomas čia, kaip ir pateikimo adresas, kuris skiriasi nuo to, kuriuo sėdi API. Tuščia leidžia krypčiai išsiaiškinti pačiai.',

        'bucket' => 'Bucket',
        'bucket_helper' => 'Bet kas, kalbantis S3 protokolu. Endpoint ir path-style jungiklis yra tai, ko reikia tiems, kurie nėra AWS; pačiam AWS palik abu ramybėje.',
        ...
        'bucket_endpoint_helper' => 'AWS palik tuščią. R2, MinIO ir visi kiti turi kiekvienas savo.',
        ...
        'cdn_title' => 'CDN',
        'cdn_helper' => 'CDN, kalbantis Modora API. Raktas yra serverio serveriui, ir jis yra pilnas admin toje paskyroje, tad į eksportuotą nuostatų failą jis nepatenka, kaip ir visi kiti čia esantys prisijungimo duomenys.',
        'cdn_base' => 'Adresas',
        'cdn_base_helper' => 'Kur gyvena API. Jei failai pateikiami iš kitur, tą adresą įrašyk aukščiau ties Skaitoma iš.',
        'cdn_token' => 'Raktas',
        'cdn_token_helper' => 'Siunčiamas kaip X-Internal-Token. Kas jį turi, tas gali rašyti į visą paskyrą ir iš jos trinti.',
        'cdn_folder' => 'Aplankas',
        'cdn_folder_helper' => 'Aplankas paskyros viduje šio skydelio failams laikyti, kad vienas CDN galėtų aptarnauti kelis skydelius jiems nelipant vienas kitam ant kojų.',

        'move' => 'Perkelti tai, kas dar skydelyje',
        'move_confirm' => 'Šoninės juostos ženklelis, skydelio fonas ir prisijungimo fonas nukopijuojami į kryptį, o jų adresai perrašomi. Kopijos šiame skydelyje paliekamos ten, kur yra, tad niekas nelūžta, jei persigalvoji. Nuo šiol įkeliami paveikslėliai vis tiek keliauja į kryptį; šitas skirtas tik tiems, kurie jau čia.',
        'move_done' => 'Perkelta',
        'move_done_body' => 'Peržiūrėta :looked, perkelta :moved, nepavyko perkelti :failed.',
        'check' => 'Išbandyti',
        'check_ok' => 'Veikia',
        'check_ok_body' => 'Failas buvo įrašytas, parsiųstas atgal jo viešu adresu ir vėl pašalintas.',
        'check_bad' => 'Tai neveikė',
        'check_panel' => 'Failus nustatyta laikyti šiame skydelyje, tad nėra ko bandyti.',
        'check_refused' => 'Kryptis failo nepriėmė ir nieko nepasakė kodėl.',
        'check_unreadable' => 'Failą ji paėmė, bet perskaityti jo atgal iš :url nepavyko. Būtent tokiu adresu naudosis naršyklė, tad failas, kurio niekas negali parsiųsti, vėliau yra sulūžęs paveikslėlis. Patikrink Skaitoma iš ir tai, ar kryptis pateikia failus viešai.',
        'bucket_missing' => 'Prieš bandant reikia rakto, paslapties ir bucket vardo - visų trijų.',
        'cdn_missing' => 'Prieš bandant reikia ir adreso, ir rakto.',
        'cdn_shape' => 'Failą jis priėmė, o paskui atsakė tokiu pavidalu, kuriame šis skydelis adreso nerado. Štai ką jis pasakė: :body',
        'mirror_minutes' => 'Ieškoti pasikeitusių kalbų kas',
        'mirror_minutes_helper' => 'Minutėmis. Ieškoti pigu: kiekviena įkelta kalba perskaitoma, sumaišoma ir palyginama su tuo, kas buvo išsiųsta paskutinį kartą, tad įprastas pravažiavimas neišsiunčia nieko. Per laidą keliauja tik ta kalba, kurią kas nors pakeitė.',
        'mirror_now' => 'Kopijuoti kalbas dabar',
        'mirror_done' => 'Kalbos nukopijuotos',
        'mirror_done_body' => 'Peržiūrėta :looked, išsiųsta :sent, nepavyko išsiųsti :failed.',
        'mirror_restore' => 'Atkurti kalbas',
        'mirror_restore_confirm' => 'Tai užrašo kiekvieną kalbą iš kopijos už skydelio ribų ant to, kas yra šiame skydelyje. Būtent dėl to tai ir daroma po atnaujinimo, o įdiegtos kalbos paskui pašalinti nebus kaip, tad verta būti tikram.',
        'mirror_back' => 'Kalbos atkurtos',
        'mirror_back_body' => 'Rasta :found, grąžinta :put, nepavyko parsiųsti :failed.',
    ],
    ...
    'pages' => [
        ...
        'files' => 'Saugykla ir CDN',
        'files_helper' => 'Kur dedami failai, kuriuos laiko šis papildinys, ir kokiu adresu jie skaitomi.',
    ],
    ...
    'features' => [
        ...
        'files' => 'Saugykla ir CDN',
        'files_helper' => 'Šio papildinio failų laikymas ne skydelyje: S3 bucket arba CDN. Išjungta nereiškia „jokių failų“ - tai skydelio paties diskas, kur jie visada ir eidavo. Šitas nusprendžia tik tai, ar bet kuri kita vieta apskritai siūloma. Kryptis, kuri neatsako, atsitraukia į skydelį, o ne pameta įkeltą failą, o jau užrašytas adresas niekada neatimamas: šito keitimas nusprendžia, kur keliaus kitas failas, o ne kur gyvena paskutinis.',
        'minecraft' => 'Minecraft',
        ...
        'updating' => 'Pranešimas apie atnaujinimą',
        'waitlist' => 'Laukiančiųjų sąrašas',
        'waitlist_helper' => 'Leidžia kam nors paprašyti, kad jam būtų pranešta, kai išparduotas paketas vėl bus parduodamas. Kai atsargų vėl atsiranda, visiems to paketo laukiantiems pranešama iš karto, o gauna tas, kas nusiperka pirmas - niekam niekas nelaikoma, ir kiekviena žinutė tai pasako. Kai pranešama, žmogus išbraukiamas iš sąrašo, tad vienas prašymas nuperka vieną pranešimą, o ne nuolatinę prenumeratą. Tam reikia parduotuvės, ir tai vienintelis dalykas parduotuvėje, kuris rašo klientui, nenusipirkusiam nieko.',
        'updating_helper' => 'Viena eilutė puslapio viršuje, kol šis papildinys diegia atnaujinimą, ir dar penkias minutes po to, kai jis baigia. Per patį atnaujinimą jos parodyti neįmanoma - kol laida keičiama, Pelican mato šį papildinį kaip neįdiegtą ir nieko iš jo neįkelia, tad nebelieka nieko mūsų, kuo būtų galima piešti. Ji skirta tam, kuris pataikė į pusiau nupieštą puslapį, palaukė ir grįžo: eilutė pasako, ką jis matė.',
        ...
        'credit' => 'Kreditas ir grąžinimai',
        'credit_helper' => 'Pinigai, kuriuos parduotuvė laiko klientui. Grąžinimas gali keliauti atgal į tą kortelę, iš kurios atėjo, arba likti paskyroje kaip kreditas; abiem atvejais parašoma kreditinė sąskaita, o paskyroje gulintis kreditas pats nusiima nuo kitos sąskaitos dar prieš klientui paprašant sumokėti. Atskira teisė, nes pažymėti sąskaitą apmokėta reiškia užrašyti, kad pinigai atėjo, o šitas pinigus dalija.',
        'upgrades' => 'Perėjimas aukštyn ir žemyn',
        'upgrades_helper' => 'Veikiančios paslaugos perkėlimas į kitą paketą neperkant naujos. Tai, kas liko iš jau apmokėto laikotarpio, grįžta atgal, ta pati atkarpa apskaičiuojama nauja kaina, o skirtumas arba išrašomas sąskaita, arba įrašomas į kliento paskyrą. Kiekvienas paketas išvardija, į kuriuos kitus galima pereiti, ir siūlomi tik tie, kurie dalijasi jo egg: kitas egg yra kitas serveris, o ne didesnis.',
        'addons' => 'Priedai',
        'addons_helper' => 'Tai, kas parduodama šalia paketo: daugiau atminties, dar viena atsarginės kopijos vieta arba kažkas, kas tėra eilutė sąskaitoje. Kiekvienas pasako, prie kurių paketų tinka ir ką prideda serveriui, o imamas arba su kiekvienu atnaujinimu, arba vieną kartą. Perkamas atsiskaitant arba vėliau, jau veikiančiai paslaugai, kur kaina paskaičiuojama pagal tai, kas liko iš laikotarpio. Atskira teisė, nes tai, ką priedas gali pridėti kieno nors serveriui, yra sprendimas apie jo mašiną, o ne apie kainoraštį.',
        'tickets' => 'Užklausos',
        'tickets_helper' => 'Vieta klientams paklausti iš paties skydelio vidaus, šalia tos paslaugos, apie kurią klausiama - o būtent to pokalbių kanalas negali. Atsakoma čia, puslapyje, arba perduodama į Discord per Modora, kaip nustatyta Užklausų puslapyje. Kiekvienas klausimas ir kiekvienas atsakymas šiaip ar taip lieka šiame skydelyje, tad nieko neprarandama, kai kito galo pasiekti nepavyksta. Atskira teisė, nes atsakinėti klientams yra darbas, kuris kam nors duodamas, o ne toks, kuris ateina kartu su kainų nustatymu.',
    ...
    'channel' => [
        ...
        'token' => 'Dev saugyklos raktas',
        'token_helper' => 'Dev kanalas skelbiamas iš privačios saugyklos, tad jai perskaityti reikia GitHub rakto - smulkiai valdomo asmeninio prieigos rakto su skaitymo teise tos saugyklos turiniui ir daugiau niekam. Stable ir beta yra vieši, ir jiems nereikia nieko. Jis lieka šiame skydelyje: į eksportuotą nuostatų failą neįrašomas.',
        'stable' => 'Stabilus',
        'beta' => 'Beta',
