...
return [
    ...
    'column_name' => 'Paketti',
    'column_flags' => 'Merkit',
    'column_flags_from' => 'alkaen :count kappaleesta',
    'column_egg' => 'Egg',
    'column_price' => 'Hinta',
    ...
    'delete_confirm_sold' => 'Myyntikertoja: :count. Noihin palveluihin ei kosketa: tilaus kantaa oman kopionsa kaikesta, minkä mukana se myytiin, joten palvelimet pyörivät edelleen ja laskut kertovat edelleen, mitä ostettiin. Vain kuva niiden palvelukortilla katoaa, eikä pakettia enää tarjota.',
    ...
    'deleted_sold' => 'Siitä myytyjä palveluita: :count - ne ovat koskemattomia ja pyörivät edelleen.',
    ...
    'upgrade_to' => 'Voidaan vaihtaa näihin',
    'upgrade_to_helper' => 'Mihin paketteihin tällä oleva käytössä oleva palvelu saa siirtyä, ylös tai alas. Listalla ovat vain samaa eggiä käyttävät paketit, koska toinen egg on toinen palvelin eikä isompi. Ei mitään valittuna tarkoittaa, ettei tästä paketista voi vaihtaa pois.',
    'upgrade_to_none' => 'Yksikään toinen paketti ei vielä käytä tätä eggiä.',
    ...
    'popular' => 'Osoita tätä',
    'popular_helper' => 'Merkitsee tämän siksi, jonka useimmat valitsevat. Se nousee kaupassa ylemmäs, tarjouksessa olevien alle, ja saa pienen merkin. Ei väite myyntiluvuista - kauppias osoittaa sormella.',
    'offer' => 'Tarjouksessa',
    'offer_helper' => 'Siirtää sen kaupan kärkeen merkin kanssa ja ottaa alla olevan alennuksen pois sen hinnasta.',
    'offer_kind' => 'Alennus muodossa',
    'offer_percent' => 'Prosentti',
    'offer_amount' => 'Rahamäärä',
    'offer_value' => 'Kuinka paljon pois',
    'offer_value_percent' => 'Prosentti hinnasta, joten 20 tarkoittaa viidesosaa pois.',
    'offer_value_amount' => 'Rahamäärä kaupan valuutassa, joten 2,50 tarkoittaa kahta ja puolta pois.',
    'offer_min' => 'Vasta tästä tuotemäärästä alkaen',
    'offer_min_helper' => 'Kuinka täysi ostoskorin on oltava ennen kuin alennus pätee, laskettuna kaikesta mitä siinä on eikä vain tästä paketista. Nolla tai yksi tarkoittaa aina. Kaksi on syy laittaa toinenkin tavara mukaan.',
];
