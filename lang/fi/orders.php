...
return [
    ...
    'cancel' => 'Peru',
    'cancel_confirm' => 'Palvelu on käynnissä :date asti eikä sitä laskuteta uudelleen. Sinä päivänä palvelin poistetaan kaikkineen. Asiakkaalle kerrotaan molemmat nyt.',
    'cancelled' => 'Peruttu',
    ...
    'not_paid' => 'Tällä tilauksella ei ole maksettua laskua, joten mitään ei rakennettu. Jos se maksettiin, se lasku jolla se maksettiin ei mainitse tätä tilausta - kerro siitä sille joka ylläpitää tätä paneelia.',
    ...
    'by_customer' => 'Asiakkaan päättämä',
    'by_admin' => 'Päätetty täällä',
    'filter_by' => 'Kuka päätti',
    'details' => 'Tiedot',
    'details_of' => 'Tilaus :number',
    'close' => 'Sulje',
    'detail_package' => 'Paketti',
    'detail_placed' => 'Tilattu',
    'detail_built' => 'Palvelin rakennettu',
    'detail_due' => 'Seuraava eräpäivä',
    'detail_ends' => 'Päättyy',
    'detail_suspended' => 'Keskeytetty',
    'detail_cancelled' => 'Peruttu',
    'detail_file_in' => 'Tiedosto viety',
    'detail_file_waiting' => 'Tiedosto',
    'detail_file_waiting_value' => 'Ladattu, odottaa palvelimen rakentamista.',
    'detail_note' => 'Viimeisin ongelma',
