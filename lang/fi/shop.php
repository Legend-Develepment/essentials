...
return [
    ...
    'section_company' => 'Kuka myy',
    'section_company_helper' => 'Se, mikä tulee jokaiselle laskulle lähettäjäksi. Suomessa, ja laajasti EU:ssa, lasku tarvitsee nimesi, osoitteesi, ALV-numerosi ja Y-tunnuksesi - asiakirja ilman niitä ei ole sellainen, jota asiakkaasi kirjanpitäjä voi käyttää. Tyhjäksi jätettynä laskulla näkyy paneelin nimi eikä muuta, mitä se tekikin ennen kuin näitä kenttiä oli.',
    'company_name' => 'Yrityksen nimi',
    'company_name_helper' => 'Nimi, jolta lasku tulee. Tyhjänä käytetään paneelin omaa nimeä.',
    'company_email' => 'Laskutussähköposti',
    'company_address' => 'Osoite',
    'company_address_helper' => 'Yksi rivi riviä kohti, siinä järjestyksessä kuin se tulostetaan. Enintään kuusi; tyhjät rivit jätetään pois.',
    'company_vat' => 'ALV-numero',
    'company_vat_helper' => 'Maatunnuksen kanssa, esimerkiksi FI12345678.',
    'company_coc' => 'Y-tunnus',
    'company_country' => 'Maatunnus',
    'company_country_helper' => 'Kaksi kirjainta, kuten FI. Tämä ratkaisee sen, onko asiakkaan ALV-numero ulkomainen - ja siten sen, onko vero hänen tilitettävänsä eikä sinun veloitettavasi.',
    'due_days' => 'Maksuaika päivinä',
    'due_days_helper' => 'Kuinka kauan jollakulla on aikaa maksaa uusi tilaus. Nolla tarkoittaa, että lasku erääntyy sinä päivänä kun se kirjoitetaan, mitä tämä kauppa teki ennen. Palvelin rakennetaan laskun maksamisen jälkeen joka tapauksessa, joten maksuaika on lause asiakirjalla eikä viive.',
    ...
    'wait_join' => 'Kerro kun se palaa',
    'wait_listed' => 'Olet listalla.',
    'wait_leave' => 'Ota minut pois',
    'wait_joined' => 'Olet listalla',
    'wait_joined_body' => 'Kuulet, kun :name on taas myynnissä. Se menee sille joka ostaa ensin, joten nopeus kannattaa.',
    'wait_left' => 'Olet pois listalta',
    'wait_refused' => 'Se ei onnistunut',
    'wait_refused_off' => 'Jonotuslista ei ole tällä hetkellä auki.',
    'wait_refused_gone' => 'Tuo paketti ei ole myynnissä.',
    'wait_refused_unlimited' => 'Tätä ei ole rajoitettu, joten se ei voi loppua.',
    'wait_refused_available' => 'Yksi on saatavilla nyt, joten odotettavaa ei ole.',
    'wait_refused_already' => 'Olet jo listalla.',
    'wait_refused_full' => 'Tämän lista on täynnä.',
    'wait_refused_many' => 'Odotat jo niin montaa asiaa kuin yksi tili saa.',
    'wait_refused_failed' => 'Sitä ei saatu tallennettua. Yritä uudelleen.',
    'plus_setup' => 'lisäksi :amount kerran',

    'spec_memory' => 'Muistia :amount MiB',
    'spec_disk' => 'Levyä :amount MiB',
    'spec_cpu' => 'CPU :amount%',
    'spec_cpu_any' => 'Suoritin rajoittamaton',
    'spec_disk_any' => 'Levy rajoittamaton',
    'spec_memory_any' => 'Muisti rajoittamaton',
    ...
    'tax_line' => 'Vero (:rate%)',
    'you_save' => 'Säästät',
    'vat_number' => 'ALV-numero (yritys)',
    'vat_placeholder' => 'Esimerkiksi FI12345678',
    'vat_shape' => 'Tuo ei ole ALV-numeron muotoinen.',
    'vat_home' => 'Säilytetään laskuasi varten. Vero veloitetaan tavalliseen tapaan.',
    'vat_reverse' => 'Vahvistettu. Tästä tilauksesta ei mene veroa - tilität sen itse.',
    'vat_unknown' => 'Tuota numeroa ei saatu vahvistettua, joten vero veloitetaan. Tarkista se, tai maksa tämä ja pyydä hyvitystä.',
    'vat_reverse_line' => 'Käännetty verovelvollisuus',
    'vat_check' => 'Tarkista ALV-numerot EU:n rekisteristä',
    'vat_check_helper' => 'Päällä numeron on oltava olemassa sen lisäksi että se näyttää oikealta, ennen kuin vero jää pois - FI99999999 on täysin oikean muotoinen eikä kuulu kenellekään. Pois päältä hyvin muotoiltu numero otetaan sanasta kiinni, mikä tarkoittaa asiakkaiden luottamista oman ALV-vastuusi kanssa. Kun rekisteriä ei tavoiteta, vero veloitetaan joka tapauksessa: katkoksesta ei saa tulla alennusta, ja laskun voi hyvittää jälkikäteen, kun ALV:tä ei aina saa takaisin.',
    'tax_line_in' => 'Sisältää ALV :rate%',
    'price_with_tax' => 'sis. ALV',
    'price_without_tax' => 'ilman ALV:tä',
    'tax_inclusive' => 'Hinnat sisältävät jo veron',
    'tax_inclusive_helper' => 'Pois päältä paketti maksaa sen mitä siinä lukee ja vero lisätään kassalla - mitä tämä kauppa on aina tehnyt. Päällä kortissa oleva hinta on se, minkä joku maksaa, ja vero on sen sisällä. Kuluttajille myyminen EU:ssa tarkoittaa sen hinnan näyttämistä, jonka he maksavat; yrityksille myyminen tarkoittaa yleensä sen näyttämistä ilman. Paketeissasi ei muutu kummassakaan tapauksessa mitään - kirjoittamasi luku on hinta, ja tämä päättää, onko vero sen päällä vai jo sisällä.',
    'coupon' => 'Alennuskoodi',
    'asks' => 'Palvelimestasi',
    ...
    'search' => 'Hae kaupasta',
    'sort' => 'Järjestä',
    'sort_featured' => 'Mitä suosittelemme',
    'sort_price_up' => 'Halvin ensin',
    'sort_price_down' => 'Kallein ensin',
    'sort_name' => 'Nimen mukaan',
    'search_none' => 'Mikään ei osunut siihen',
    'search_none_body' => 'Kokeile lyhyempää sanaa, tai tyhjennä kenttä nähdäksesi taas kaiken.',
    'search_count' => '{1} yksi paketti|[2,*] :count pakettia',
    'services_ended' => 'Päättämäsi palvelut',
    'services_ended_helper' => 'Suljettu eikä enää laskuteta. Säilytetään täällä, jotta voit osoittaa jotain niistä ja jotta niiden takana olevat laskut käyvät yhä järkeen.',

    // ---- yksi palvelu omalla sivullaan -----------------------------------
    'service_title' => 'Palvelu',
    'service_subheading' => 'Kaikki tästä yhdestä palvelusta.',
    'service_manage' => 'Kaikki tästä palvelusta',
    'service_back' => 'Kaikki palvelut',
    'service_gone' => 'Sitä palvelua ei ole täällä',
    'service_gone_body' => 'Sitä ei koskaan ollut, tai se ei ole sinun. Omat palvelusi ovat palvelusivullasi.',
    'service_next' => 'Mitä se maksaa ensi kerralla',
    'service_next_bundled' => 'Uusinnat lähetetään yhtenä laskuna päivää kohti, joten samana päivänä erääntyvä palvelu laskutetaan samalla asiakirjalla.',
    'service_bills' => 'Mitä siitä on laskutettu',
    'service_bills_none' => 'Tästä palvelusta ei ole vielä laskutettu mitään.',
    'service_notes' => 'Ja mitä tuli takaisin',
    'service_share' => 'Tämä palvelu:',
    'service_owed' => 'Maksettavaa:',
    'service_paid_on' => 'Maksettu',
    'service_pay' => 'Maksa tämä',
    'service_asked' => 'Mitä olet kysynyt siitä',
    'service_asked_none' => 'Et ole kysynyt mitään tästä palvelusta.',
    'service_stuck' => 'Muutos ei mennyt läpi',
    'service_stuck_body' => 'Vaihto pakettiin :name maksettiin eikä palvelin ottanut sitä vastaan. Mitään ei ole menetetty - kysy tästä palvelusta, niin asia oikaistaan.',

    // ---- ostoskori -------------------------------------------------------
    'basket_add' => 'Lisää ostoskoriin',
    'basket_added' => ':name on ostoskorissasi.',
    'basket_full' => 'Ostoskoriin mahtuu :count tavaraa. Osta nämä ensin, tai ota jotain pois.',
    'basket_title' => 'Ostoskorisi',
    'basket_subheading' => 'Kaikki mitä olet valinnut, yhdellä laskulla. Se minkä ostat yhdessä uusiutuu yhdessä.',
    'basket_empty' => 'Ostoskorisi on tyhjä',
    'basket_empty_body' => 'Valitse jotain kaupasta, niin se ilmestyy tänne.',
    'basket_remove' => 'Ota tämä pois',
    'basket_clear' => 'Tyhjennä ostoskori',
    'basket_buy' => 'Osta kaikki',
    'basket_more' => 'Lisää jotain muuta',
    'refused_empty_basket' => 'Ostoskorissasi ei ole mitään.',
    ...
    'check_same' => 'Client ID ja secret ovat sama arvo. PayPal näyttää client id:n avoimena ja piilottaa secretin Show-linkin taakse, joten saman on helppo kopioida kahdesti - avaa sovellus osoitteessa developer.paypal.com ja paljasta secret.',
    ...
    'basket' => 'Anna asiakkaiden ostaa useita asioita kerralla',
    'basket_helper' => 'Lisää ostoskorin: useita palveluita yhdellä laskulla, uusiutumassa yhdessä. Pois päältä kauppa myy yhden paketin kerrallaan. Ennen päälle laittamista kannattaa tietää: yksi lasku on yksi velka, joten maksamaton yhteinen lasku keskeyttää jokaisen siinä olevan palvelun - ja peruttu palvelu lähtee pois jokaiselta laskulta, jota ei ole vielä maksettu.',
    'offer_flag' => 'Tarjous',
    'saved_amount' => 'Säästä :amount',
    'popular_flag' => 'Valituin',
    'offer_from' => 'Säästä :amount :count tavarasta alkaen',
    'details' => 'Tietosi',
    'details_helper' => 'Se, mikä tulee laskuillesi. Palvelimen ostava yritys tarvitsee nimensä, osoitteensa ja maansa asiakirjalle; itselleen ostava ei tarvitse mitään näistä ja voi jättää ne tyhjiksi.',
    'details_company' => 'Yritys',
    'details_company_helper' => 'Jätä tyhjäksi, jos et osta yritykselle - silloin käytetään omaa nimeäsi.',
    'details_address' => 'Osoite',
    'details_address_helper' => 'Yksi rivi riviä kohti, siinä järjestyksessä kuin se tulostetaan.',
    'details_postcode' => 'Postinumero',
    'details_city' => 'Kaupunki',
    'details_country' => 'Maatunnus',
    'details_country_helper' => 'Kaksi kirjainta, kuten FI. Se ratkaisee, mikä vero sinua koskee.',
    'details_phone' => 'Puhelin',
    'details_vat_helper' => 'Toisessa EU-maassa olevalle yritykselle: kelvollisen numeron kanssa vero on sinun tilitettäväsi eikä tämä kauppa veloita sitä.',
    'details_failed' => 'Niitä ei saatu tallennettua. Yritä uudelleen, ja kerro sille joka pitää tätä paneelia jos se jatkuu.',
];
