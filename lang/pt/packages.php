...
return [
    ...
    'delete_confirm_sold' => 'Já foi vendido :count vezes. Esses serviços não são tocados: uma encomenda leva a sua própria cópia de tudo aquilo com que foi vendida, por isso os servidores continuam a correr e as faturas continuam a dizer o que foi comprado. Só desaparece a imagem no cartão do serviço deles, e o pacote sai de venda.',
    ...
    'deleted_sold' => 'Os :count serviços vendidos a partir dele ficam intactos e continuam a correr.',
    ...
    'upgrade_to' => 'Pode mudar para',
    'upgrade_to_helper' => 'Para que pacotes é que um serviço a correr neste pode ser movido, para cima ou para baixo. Só aparecem pacotes que usam o mesmo egg, porque um egg diferente é outro servidor em vez de um maior. Nada marcado significa que deste pacote não se pode mudar para nenhum.',
    'upgrade_to_none' => 'Ainda não há outro pacote a usar este egg.',
    ...
    'popular' => 'Apontar para este',
    'popular_helper' => 'Marca-o como aquele que a maioria escolhe. Sobe na loja, por baixo do que estiver em promoção, e leva uma pequena etiqueta. Não é uma afirmação sobre números de vendas - é um lojista a apontar.',
    'offer' => 'Em promoção',
    'offer_helper' => 'Põe-no à frente na loja com uma etiqueta, e tira o desconto abaixo ao preço dele.',
    'offer_kind' => 'Desconto como',
    'offer_percent' => 'Uma percentagem',
    'offer_amount' => 'Um valor',
    'offer_value' => 'Quanto desconta',
    'offer_value_percent' => 'Uma percentagem do preço, por isso 20 é um quinto a menos.',
    'offer_value_amount' => 'Um valor na moeda da loja, por isso 2.50 são dois e meio a menos.',
    'offer_min' => 'Só a partir deste número de artigos',
    'offer_min_helper' => 'Quão cheio tem de estar o carrinho antes de o desconto valer, contando tudo o que lá está e não só este pacote. Zero ou um quer dizer sempre. Dois é uma razão para pôr lá uma segunda coisa.',
];
