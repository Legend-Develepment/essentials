...
return [
    ...
    'cancel' => 'Cancelar',
    'cancel_confirm' => 'O serviço corre até :date e não volta a ser faturado. Nesse dia o servidor é apagado, com tudo o que tem dentro. O cliente fica a saber ambas as coisas agora.',
    'cancelled' => 'Cancelada',
    ...
    'not_paid' => 'Esta encomenda não tem nenhuma fatura paga, por isso não foi criado nada. Se foi paga, a fatura em que foi paga não menciona esta encomenda - avise quem gere este painel.',
    ...
    'by_customer' => 'Terminado pelo cliente',
    'by_admin' => 'Terminado aqui',
    'filter_by' => 'Quem terminou',
    'details' => 'Detalhes',
    'details_of' => 'Encomenda :number',
    'close' => 'Fechar',
    'detail_package' => 'Pacote',
    'detail_placed' => 'Encomendado',
    'detail_built' => 'Servidor criado',
    'detail_due' => 'Próximo vencimento',
    'detail_ends' => 'Termina',
    'detail_suspended' => 'Suspenso',
    'detail_cancelled' => 'Cancelado',
    'detail_file_in' => 'Ficheiro colocado',
    'detail_file_waiting' => 'Ficheiro',
    'detail_file_waiting_value' => 'Carregado, à espera que o servidor seja criado.',
