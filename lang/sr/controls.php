...
return [
    ...
    'stop' => 'Заустави',
    'kill' => 'Kill',
    'kill_confirm' => 'Kill зауставља контејнер одмах. Све што сервер још није уписао на диск биће изгубљено. Наставити?',
    'sent_title' => 'Радња напајања',
    'sent_body' => ':action је послато на :name.',
    'failed' => 'Чвор није био доступан.',
];
