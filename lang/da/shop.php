...
return [
    ...
    'section_company' => 'Hvem der sælger',
    'section_company_helper' => 'Det, der står som afsender på hver faktura. I Danmark, og bredt set i hele EU, skal en faktura have dit navn, din adresse, dit momsnummer og dit CVR-nummer - et dokument uden dem er ikke et, kundens revisor kan bruge. Står felterne tomme, viser fakturaen panelets navn og ikke andet, og det er, hvad den gjorde, før felterne fandtes.',
    'company_name' => 'Firmanavn',
    'company_name_helper' => 'Det navn, fakturaen kommer fra. Tomt bruger panelets eget navn.',
    'company_email' => 'Faktureringsmail',
    'company_address' => 'Adresse',
    'company_address_helper' => 'Én linje ad gangen, i den rækkefølge de skal trykkes. Op til seks; tomme linjer bliver udeladt.',
    'company_vat' => 'Momsnummer',
    'company_vat_helper' => 'Med landekoden foran, for eksempel DK12345678.',
    'company_coc' => 'CVR-nummer',
    'company_country' => 'Landekode',
    'company_country_helper' => 'To bogstaver, som DK. Det er dét, der afgør, om en kundes momsnummer er et udenlandsk et - og dermed, om momsen er deres at afregne i stedet for din at opkræve.',
    'due_days' => 'Betalingsfrist, i dage',
    'due_days_helper' => 'Hvor lang tid nogen har til at betale en ny ordre. Nul betyder, at fakturaen forfalder den dag, den skrives, og det er, hvad denne butik gjorde før. Serveren bygges, når fakturaen er betalt, uanset hvad, så en frist er en sætning på dokumentet frem for en udsættelse.',
    ...
    'buy' => 'Køb',
    'sold_out' => 'Udsolgt',
    'wait_join' => 'Sig til, når den er tilbage',
    'wait_listed' => 'Du står på listen.',
    'wait_leave' => 'Tag mig af',
    'wait_joined' => 'Du står på listen',
    'wait_joined_body' => 'Du hører fra os, når :name er til salg igen. Den går til den, der køber først, så det kan betale sig at være hurtig.',
    'wait_left' => 'Du står ikke på listen længere',
    'wait_refused' => 'Det virkede ikke',
    'wait_refused_off' => 'Ventelisten er ikke åben lige nu.',
    'wait_refused_gone' => 'Den pakke er ikke til salg.',
    'wait_refused_unlimited' => 'Denne her er ikke begrænset, så den kan ikke løbe tør.',
    'wait_refused_available' => 'Der er en ledig nu, så der er ikke noget at vente på.',
    'wait_refused_already' => 'Du står allerede på listen.',
    'wait_refused_full' => 'Listen for denne her er fuld.',
    'wait_refused_many' => 'Du venter på lige så mange ting, som én konto må.',
    'wait_refused_failed' => 'Det kunne ikke gemmes. Prøv igen.',
    'plus_setup' => 'plus :amount én gang',

    'spec_memory' => ':amount MiB hukommelse',
    'spec_disk' => ':amount MiB disk',
    'spec_cpu' => ':amount% CPU',
    'spec_cpu_any' => 'Processor uden grænse',
    'spec_disk_any' => 'Disk uden grænse',
    'spec_memory_any' => 'Hukommelse uden grænse',
    'spec_backups' => '{1} én sikkerhedskopi|[2,*] :count sikkerhedskopier',
    ...
    'tax_line' => 'Moms (:rate%)',
    'you_save' => 'Du sparer',
    'vat_number' => 'Momsnummer (virksomhed)',
    'vat_placeholder' => 'For eksempel DK12345678',
    'vat_shape' => 'Det er ikke formet som et momsnummer.',
    'vat_home' => 'Gemt til din faktura. Momsen opkræves som sædvanlig.',
    'vat_reverse' => 'Bekræftet. Ingen moms på denne ordre - du afregner den selv.',
    'vat_unknown' => 'Det nummer kunne ikke bekræftes, så momsen opkræves. Tjek det, eller betal denne og bed om en kreditnota.',
    'vat_reverse_line' => 'Omvendt betalingspligt',
    'vat_check' => 'Tjek momsnumre mod EU-registret',
    'vat_check_helper' => 'Tændt skal et nummer både findes og se rigtigt ud, før momsen ryger af - DK99999999 er formelt helt i orden og tilhører ingen. Slukket bliver et velformet nummer taget for pålydende, og det er at lade kunderne bestemme over dit eget momsansvar. Kan registret ikke nås, opkræves momsen under alle omstændigheder: en nedetid må ikke blive til en rabat, og en faktura kan krediteres bagefter, mens moms ikke altid kan hentes hjem igen.',
    'tax_line_in' => 'Inklusive moms på :rate%',
    'price_with_tax' => 'inkl. moms',
    'price_without_tax' => 'ekskl. moms',
    'tax_inclusive' => 'Priserne indeholder allerede moms',
    'tax_inclusive_helper' => 'Slukket koster en pakke det, der står, og momsen lægges på ved kassen - og det er, hvad denne butik altid har gjort. Tændt er prisen på kortet det, kunden betaler, med momsen indeni. Sælger du til forbrugere i EU, skal du vise den pris, de betaler; sælger du til virksomheder, viser man den som regel uden. Der ændrer sig ikke noget ved dine pakker af den grund - det tal, du har skrevet, er prisen, og det her afgør, om momsen ligger oven på den eller allerede er i den.',
    'coupon' => 'Rabatkode',
    'asks' => 'Om din server',
    ...
    'search' => 'Søg i butikken',
    'sort' => 'Sortér efter',
    'sort_featured' => 'Det, vi foreslår',
    'sort_price_up' => 'Billigste først',
    'sort_price_down' => 'Dyreste først',
    'sort_name' => 'Efter navn',
    'search_none' => 'Der var ikke noget, der passede',
    'search_none_body' => 'Prøv et kortere ord, eller ryd feltet for at se det hele igen.',
    'search_count' => '{1} én pakke|[2,*] :count pakker',
    'services_ended' => 'Ydelser, du har afsluttet',
    'services_ended_helper' => 'Lukkede og faktureres ikke længere. De bliver stående her, så du kan pege på en, og så fakturaerne bag dem stadig giver mening.',
    // ---- én ydelse, på sin egen side --------------------------------------
    'service_title' => 'Ydelse',
    'service_subheading' => 'Alt om denne ene ydelse.',
    'service_manage' => 'Alt om denne ydelse',
    'service_back' => 'Alle ydelser',
    'service_gone' => 'Den ydelse er her ikke',
    'service_gone_body' => 'Den har aldrig været der, eller den er ikke din. Dine egne ydelser står på siden med ydelser.',
    'service_next' => 'Hvad den koster næste gang',
    'service_next_bundled' => 'Fornyelser sendes som én regning om dagen, så en ydelse, der forfalder samme dag som en anden, står på det samme dokument.',
    'service_bills' => 'Hvad der er faktureret for den',
    'service_bills_none' => 'Der er endnu ikke faktureret noget for denne ydelse.',
    'service_notes' => 'Og hvad der kom retur',
    'service_share' => 'Denne ydelse:',
    'service_owed' => 'At betale:',
    'service_paid_on' => 'Betalt',
    'service_pay' => 'Betal denne',
    'service_asked' => 'Det, du har spurgt om den',
    'service_asked_none' => 'Du har ikke spurgt om noget til denne ydelse.',
    'service_stuck' => 'En ændring gik ikke igennem',
    'service_stuck_body' => 'Skiftet til :name blev betalt, og serveren tog det ikke. Der er ikke gået noget tabt - spørg til denne ydelse, så bliver det bragt i orden.',

    // ---- kurven -----------------------------------------------------------
    'basket_add' => 'Læg i kurven',
    'basket_added' => ':name ligger i din kurv.',
    'basket_full' => 'Der er plads til :count ting i en kurv. Køb disse først, eller tag noget ud.',
    'basket_title' => 'Din kurv',
    'basket_subheading' => 'Alt, du har valgt ud, på én faktura. Det, du køber sammen, fornyes sammen.',
    'basket_empty' => 'Din kurv er tom',
    'basket_empty_body' => 'Vælg noget i butikken, så dukker det op her.',
    'basket_remove' => 'Tag denne ud',
    'basket_clear' => 'Tøm kurven',
    'basket_buy' => 'Køb det hele',
    'basket_more' => 'Læg noget mere i',
    'refused_empty_basket' => 'Der er ikke noget i din kurv.',
    ...
    'check_live' => 'live',
    'check_same' => 'Client ID og Secret er den samme værdi. PayPal viser client ID åbent og gemmer Secret bag et Show-link, så det er nemt at komme til at kopiere den samme to gange - åbn appen på developer.paypal.com, og vis Secret.',
    ...
    'basket' => 'Lad kunderne købe flere ting ad gangen',
    'basket_helper' => 'Lægger en kurv til: flere ydelser på én faktura, der fornyes sammen. Slukket sælger butikken én pakke ad gangen. Værd at vide, før du slår det til: én faktura er én gæld, så en fælles regning, der ikke bliver betalt, suspenderer hver eneste ydelse på den - og en ydelse, der bliver annulleret, ryger af enhver regning, der endnu ikke er betalt.',
    'offer_flag' => 'Tilbud',
    'saved_amount' => 'Spar :amount',
    'popular_flag' => 'Flest vælger denne',
    'offer_from' => 'Spar :amount fra :count varer',
    'details' => 'Dine oplysninger',
    'details_helper' => 'Det, der står på dine fakturaer. En virksomhed, der køber en server, skal have sit navn, sin adresse og sit land på dokumentet; den, der køber en til sig selv, skal ikke bruge noget af det og kan lade det stå tomt.',
    'details_company' => 'Virksomhed',
    'details_company_helper' => 'Lad den stå tom, hvis du ikke køber til en virksomhed - så bruges dit eget navn.',
    'details_address' => 'Adresse',
    'details_address_helper' => 'Én linje ad gangen, i den rækkefølge de skal trykkes.',
    'details_postcode' => 'Postnummer',
    'details_city' => 'By',
    'details_country' => 'Landekode',
    'details_country_helper' => 'To bogstaver, som DK. Det afgør, hvilken moms der gælder for dig.',
    'details_phone' => 'Telefon',
    'details_vat_helper' => 'For en virksomhed i et andet EU-land: med et gyldigt nummer er momsen din at afregne, og denne butik opkræver ingen.',
    'details_failed' => 'De kunne ikke gemmes. Prøv igen, og sig det til den, der driver dette panel, hvis det bliver ved.',
];
