...
return [
    ...
    'cancel' => 'Annullér',
    'cancel_confirm' => 'Ydelsen kører til :date og bliver ikke faktureret igen. Den dag slettes serveren med alt, hvad der er på den. Kunden får begge dele at vide nu.',
    ...
    'not_paid' => 'Der hører ingen betalt faktura til denne ordre, så der blev ikke bygget noget. Er den alligevel betalt, nævner den faktura ikke denne ordre - sig det til den, der driver dette panel.',
    ...
    'by_customer' => 'Afsluttet af kunden',
    'by_admin' => 'Afsluttet her',
    'filter_by' => 'Hvem afsluttede',
    'details' => 'Detaljer',
    'details_of' => 'Ordre :number',
    'close' => 'Luk',
    'detail_package' => 'Pakke',
    'detail_placed' => 'Bestilt',
    'detail_built' => 'Server bygget',
    'detail_due' => 'Næste forfald',
    'detail_ends' => 'Ophører',
    'detail_suspended' => 'Suspenderet',
    'detail_cancelled' => 'Annulleret',
    'detail_file_in' => 'Fil lagt ind',
    'detail_file_waiting' => 'Fil',
    'detail_file_waiting_value' => 'Lagt op, venter på at serveren bliver bygget.',
    'detail_note' => 'Sidste problem',
