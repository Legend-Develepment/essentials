...
return [
    ...
    'landing' => '상점을 먼저 열기',
    'landing_helper' => '켜면 로그인 뒤 첫 페이지가 상점이 되고, 서버 목록은 그 옆으로 옮겨간다. 내 서비스와 청구서는 상점 머리글과 계정 메뉴에서 한 번에 열린다. 로그인하지 않은 사람에게는 로그인 화면 대신 공개 상점이 보이고, 패키지를 고른 뒤에야 로그인을 요구한다. 그래서 공개 상점 페이지도 함께 켜져 있어야 한다. 끄면 아무것도 옮겨가지 않고, 상점은 다른 페이지와 같은 한 페이지가 된다.',
];
