...
return [
    ...
    'kind_credit' => 'Kreditfaktura',
    'kind_upgrade' => 'Paketbyte',
    'kind_topup' => 'Påfyllt tillgodo',
    'kind_addon' => 'Tillägg',
    ...
    'order_count' => ':count tjänster',
    'no_due' => 'Inget datum',
    'gone_customer' => 'Konto borttaget',
    'discount_of' => ':amount rabatt med :code',
    'paid_via' => 'genom :how',
    'column_attempts' => 'Betalning',
    'paid_by' => 'betald med :how',
    'paid_by_unknown' => 'betald',
    'paid_by_manual' => 'handen',
    'paid_by_free' => 'inget att betala',
    'attempts_none' => 'inget försök',
    'attempts_open' => ':count försök - :how',
    'attempt_last' => 'senast :when, :state',
    'attempt_open' => 'inte klar',
    'attempt_paid' => 'betald',
    'attempt_cancelled' => 'avbruten',
    'attempt_failed' => 'misslyckades',
    'emailed' => 'Skickad',
