...
return [
    ...
    'cancel' => 'Cancelar',
    'cancel_confirm' => 'El servicio funciona hasta el :date y no se vuelve a cobrar. Ese día se borra el servidor con todo lo que tenga dentro. Al cliente se le avisa de ambas cosas ahora.',
    'cancelled' => 'Cancelado',
    ...
    'not_paid' => 'Este pedido no tiene ninguna factura pagada, así que no se ha creado nada. Si sí se pagó, la factura en la que se pagó no menciona este pedido - avisa a quien lleve este panel.',
    ...
    'by_customer' => 'Terminado por el cliente',
    'by_admin' => 'Terminado aquí',
    'filter_by' => 'Quién lo terminó',
    'details' => 'Detalles',
