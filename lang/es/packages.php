...
return [
    ...
    'delete_confirm_sold' => 'Se ha vendido :count veces. Esos servicios no se tocan: un pedido lleva su propia copia de todo con lo que se vendió, así que los servidores siguen funcionando y las facturas siguen diciendo qué se compró. Solo se va la imagen de su tarjeta de servicio, y el paquete deja de ofrecerse.',
    ...
    'deleted_sold' => 'Los :count servicios vendidos con él quedan intactos y siguen funcionando.',
    ...
    'upgrade_to' => 'Se puede cambiar a',
    'upgrade_to_helper' => 'A qué paquetes se puede mover un servicio en marcha que esté en este, hacia arriba o hacia abajo. Solo se listan los paquetes que usan el mismo egg, porque otro egg es otro servidor y no uno más grande. Nada marcado significa que desde este paquete no se puede cambiar.',
    'upgrade_to_none' => 'Todavía no hay ningún otro paquete que use este egg.',
    ...
    'term' => 'Permanencia mínima',
    'term_helper' => 'Cuánto tiempo se compromete alguien al comprar. Cero es ningún compromiso: puede cancelar y termina al final del periodo que ha pagado.',
    'term_unit' => 'Contada en',
    'term_unit_helper' => 'Días, meses o años. Un pedido cancelado llega hasta el final de esta permanencia y el servidor se borra ese día.',
    'unit_day' => 'Días',
    'unit_month' => 'Meses',
    'unit_year' => 'Años',
    'term_day' => 'Permanencia mínima: :count días',
    'term_month' => 'Permanencia mínima: :count meses',
    'term_year' => 'Permanencia mínima: :count años',
    'section_art' => 'Imagen',
    'section_art_helper' => 'La imagen de la tarjeta del paquete, en la tienda y en los servicios de un cliente. Deja los dos vacíos y se usa la imagen propia del egg, que la mayoría de los paquetes ya tienen.',
    'art_file' => 'Subir una imagen',
    'art_file_helper' => 'Ancha y no alta: la tarjeta la recorta a 16:9. Hasta 8 MB.',
    'art_url' => 'O una dirección de imagen',
    'art_url_helper' => 'Una dirección https completa. Se usa cuando arriba no se ha subido nada.',

    'empty' => 'Aún no hay paquetes',
    'section_ask' => 'Preguntar al cliente',
    'section_ask_helper' => 'Preguntas puestas en el pago, respondidas antes de hacer el pedido. Las respuestas llegan al servidor cuando se crea.',
    'ask_vars' => 'Variables por las que preguntar',
    'ask_vars_helper' => 'Las variables propias del egg. Marca una y el cliente la rellena mientras compra, y su respuesta se usa en lugar del valor de este paquete. Deja todo sin marcar y no se le pregunta nada a nadie.',
    'upload_ask' => 'Pedir un archivo',
    'upload_ask_helper' => 'Un zip que el cliente sube mientras compra: un mundo, un modpack, un juego de configuraciones. Se mete en su servidor cuando se crea, antes de decirle que está listo.',
    'upload_label' => 'Cómo llamarlo',
    'upload_label_helper' => 'La etiqueta encima del campo de archivo, con tus palabras. Vacío usa una sencilla.',
    'upload_dir' => 'Dónde dentro del servidor',
    'upload_dir_helper' => 'Una ruta dentro del servidor, como / o /world. Se sanea antes de usarla.',
    'upload_extract' => 'Descomprimirlo',
    'upload_extract_helper' => 'Encendido, el zip se descomprime donde aterriza y el archivo comprimido se quita: es lo correcto para un mundo o un juego de configuraciones. Apagado, el zip se queda como archivo, que es lo que quiere un egg que instala un modpack a partir de él.',
    'empty_body' => 'Crea uno y aparece en la tienda en cuanto se ponga a la venta.',
    'popular' => 'Señalar este',
    'popular_helper' => 'Lo marca como el que elige la mayoría. Sube en la tienda, por debajo de lo que esté en oferta, y lleva un distintivo pequeño. No es una afirmación sobre las cifras de venta - es un tendero señalando.',
    'offer' => 'En oferta',
    'offer_helper' => 'Lo pone al principio de la tienda con un distintivo, y le quita del precio el descuento de abajo.',
    'offer_kind' => 'Descuento como',
    'offer_percent' => 'Un porcentaje',
    'offer_amount' => 'Un importe',
    'offer_value' => 'Cuánto se descuenta',
    'offer_value_percent' => 'Un porcentaje del precio, así que 20 significa una quinta parte menos.',
    'offer_value_amount' => 'Un importe en la moneda de la tienda, así que 2,50 significa dos con cincuenta menos.',
    'offer_min' => 'Solo a partir de tantos artículos',
    'offer_min_helper' => 'Lo llena que tiene que estar la cesta antes de que se aplique el descuento, contando todo lo que hay dentro y no solo este paquete. Cero o uno significa que se aplica siempre. Dos es una razón para meter algo más.',
];
