...
return [
    ...
    'cancel' => 'Zrušiť',
    'cancel_confirm' => 'Služba beží do :date a znovu sa neúčtuje. V ten deň sa server zmaže aj so všetkým, čo je na ňom. Zákazník sa obe veci dozvie teraz.',
    'cancelled' => 'Zrušené',
    ...
    'not_paid' => 'K tejto objednávke nepatrí žiadna zaplatená faktúra, takže sa nič nepostavilo. Ak zaplatená bola, tá faktúra túto objednávku neuvádza - povedz to tomu, kto tento panel spravuje.',
