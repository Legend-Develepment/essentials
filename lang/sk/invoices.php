...
return [
    ...
    'kind_credit' => 'Dobropis',
    'kind_upgrade' => 'Zmena balíka',
    'kind_topup' => 'Dobitie kreditu',
    'kind_addon' => 'Doplnok',
    ...
    'order_count' => 'Služby: :count',
    'no_due' => 'Bez dátumu',
    'gone_customer' => 'Účet zmazaný',
    'discount_of' => ':amount zľava s kódom :code',
    'paid_via' => 'cez :how',
    'column_attempts' => 'Platba',
    'paid_by' => 'zaplatené: :how',
    'paid_by_unknown' => 'neuvedené',
    'paid_by_manual' => 'ručne',
    'paid_by_free' => 'nebolo čo platiť',
    'attempts_none' => 'bez pokusu',
    'attempts_open' => 'Pokusov: :count - :how',
    'attempt_last' => 'posledný :when, :state',
    'attempt_open' => 'nedokončený',
    'attempt_paid' => 'zaplatený',
    'attempt_cancelled' => 'zrušený',
    'attempt_failed' => 'zlyhal',
    'emailed' => 'Odoslaná',
    ...
    'bell_reminder' => 'Faktúra :number je po splatnosti',
    'bell_reminder_body' => 'Stále je otvorená na :total. Server, ktorý platí, sa :date zastaví, ak dovtedy nebude vyrovnaná, a nič na ňom sa pritom nezmaže.',
];
