...
return [
    ...
    'delete_confirm_sold' => 'Predajov: :count. Tie služby ostanú nedotknuté: objednávka nesie vlastnú kópiu všetkého, s čím bola predaná, takže servery bežia ďalej a faktúry naďalej hovoria, čo bolo kúpené. Zmizne len obrázok na karte ich služby a balík sa prestane ponúkať.',
    ...
    'deleted_sold' => 'Predaných služieb z neho: :count - ostávajú nedotknuté a bežia ďalej.',
    'saved' => 'Balík uložený',
    ...
    'upgrade_to' => 'Dá sa zmeniť na',
    'upgrade_to_helper' => 'Na ktoré balíky sa smie bežiaca služba z tohto balíka presunúť, hore aj dole. V zozname sú len balíky s rovnakým eggom, lebo iný egg je iný server, nie väčší. Nič nezaškrtnuté znamená, že z tohto balíka sa zmeniť nedá.',
    'upgrade_to_none' => 'Tento egg zatiaľ nepoužíva žiadny iný balík.',
    ...
    'popular' => 'Ukázať na tento',
    'popular_helper' => 'Označí ho ako ten, ktorý si vyberá väčšina. Posunie sa v obchode vyššie, pod to, čo je v akcii, a nesie malý štítok. Nie je to tvrdenie o číslach predaja - je to obchodník, ktorý ukazuje.',
    'offer' => 'V akcii',
    'offer_helper' => 'Posunie ho na začiatok obchodu so štítkom a odpočíta zľavu nižšie z jeho ceny.',
    'offer_kind' => 'Zľava ako',
    'offer_percent' => 'Percento',
    'offer_amount' => 'Suma',
    'offer_value' => 'O koľko menej',
    'offer_value_percent' => 'Percento z ceny, takže 20 znamená o pätinu menej.',
    'offer_value_amount' => 'Suma v mene obchodu, takže 2.50 znamená o dva a pol menej.',
    'offer_min' => 'Až od toľkých položiek',
    'offer_min_helper' => 'Aký plný musí byť košík, než sa zľava uplatní; počíta sa všetko v ňom, nie len tento balík. Nula alebo jedna znamená, že platí vždy. Dva je dôvod pridať druhú vec.',
];
