...
/**
 * The plugin's own state, on the dashboard: which version is installed, which
 * channel it follows, whether something newer is waiting, and - when the panel
 * updates itself - when it next looks.
 *
 * On the dashboard rather than only on the theme's page, because "is there an
 * update" is a question you have before you go looking, not after.
 *
