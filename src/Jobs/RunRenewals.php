...
class RunRenewals implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            /*
             * Balances against bills, before anything is chased.
             *
             * A customer with money on account and an overdue invoice should
             * not be reminded about it, and certainly should not be suspended
             * over it. Money landing on a balance already settles what is owed
             * - see Credits::add() - so this is the sweep that catches whatever
             * did not go through that door: a balance written before this
             * release, or an invoice that fell due after the money arrived.
             */
            Credits::sweep();
