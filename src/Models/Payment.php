...
class Payment extends Model
{
    ...
    protected $fillable = [
        ...
        'state',
        'amount',
        // How much of that has since gone back to where it came from. On the
        // payment rather than on the invoice, because a refund is against the
        // thing the provider actually holds.
        'refunded',
        'currency',
        'raw',
        'paid_at',
