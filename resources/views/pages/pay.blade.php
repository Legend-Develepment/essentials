        ...
        <div class="ld-pay">
            ...
            <section class="ld-pay-invoice">
                ...
                <table class="ld-checkout-lines">
                    ...
                    <tr @class(['ld-checkout-total' => $summary['credit'] === null])>
                        <td>{{ $words['total'] }}</td>
                        <td class="ld-checkout-money">{{ $summary['total'] }}</td>
                    </tr>

                    {{-- What the balance covered, and what is left after it.
                         Both lines or neither: a smaller figure with no line
                         explaining it reads as a mistake in the customer's
                         favour, which is the sort of thing people write in
                         about. --}}
                    @if ($summary['credit'] !== null)
                        <tr>
                            <td>{{ $words['credit'] }}</td>
                            <td class="ld-checkout-money">-{{ $summary['credit'] }}</td>
                        </tr>

                        <tr class="ld-checkout-total">
                            <td>{{ $words['payable'] }}</td>
                            <td class="ld-checkout-money">{{ $summary['payable'] }}</td>
                        </tr>
                    @endif
                </table>
                            ...
                            <li>
                                ...
                                <button type="button"
                                    ...
                                    <span class="ld-pay-method-text">
                                        {{-- The company's own name, because
                                             that is what the button leads to
                                             and what the money lands in. It
                                             said "Card" and carried the
                                             provider beside it in small type,
                                             which read as Stripe Stripe the
                                             moment the label became the name. --}}
